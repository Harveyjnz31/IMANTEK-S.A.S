...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:va,depthTest:!1,depthWrite:!1})}function gb(o,e,i){const s=new Float32Array(Ls),l=new $(0,1,0);return new Yi({name:"SphericalGaussianBlur",defines:{n:Ls,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:nu(),fragmentShader:`
		...
		`,blending:va,depthTest:!1,depthWrite:!1})}function F_(){return new Yi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:nu(),fragmentShader:`
		...
		`,blending:va,depthTest:!1,depthWrite:!1})}function z_(){return new Yi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nu(),fragmentShader:`
...
`)}function AT(o,e){const i={},s=o.getProgramParameter(e,o.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=o.getActiveAttrib(e,l),d=c.name;let p=1;c.type===o.FLOAT_MAT2&&(p=2),c.type===o.FLOAT_MAT3&&(p=3),c.type===o.FLOAT_MAT4&&(p=4),i[d]={type:c.type,location:o.getAttribLocation(e,d),locationSize:p}}return i}function qo(o){return o!==""}function j_(o,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Z_(o,e){return o.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const RT=/^[ \t]*#include +<([\w\d./]+)>/gm;function Vh(o){return o.replace(RT,wT)}const CT=new Map;function wT(o,e){let i=ue[e];if(i===void 0){const s=CT.get(e);if(s!==void 0)i=ue[s],$t('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,s);else throw new Error("Can not resolve #include <"+e+">")}return Vh(i)}const DT=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function K_(o){return o.replace(DT,UT)}function UT(o,e,i,s){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function Q_(o){let e=`precision ${o.precision} float;
...
}`;class dA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i){if(this.texture===null){const s=new Rv(e.texture);(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(e){if(this.texture!==null&&this.mesh===null){const i=e.cameras[0].viewport,s=new Yi({vertexShader:uA,fragmentShader:fA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new ui(new Jo(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class hA extends zs{constructor(e,i){super();const s=this;let l=null,c=1,d=null,p="local-floor",m=1,h=null,x=null,v=null,g=null,M=null,b=null;const w=typeof XRWebGLBinding<"u",y=new dA,S={},C=i.getContextAttributes();let N=null,P=null;const G=[],U=[],F=new Ue;let T=null;const L=new li;L.viewport=new sn;const Y=new li;Y.viewport=new sn;const H=[L,Y],K=new yM;let lt=null,ut=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(rt){let St=G[rt];return St===void 0&&(St=new Ed,G[rt]=St),St.getTargetRaySpace()},this.getControllerGrip=function(rt){let St=G[rt];return St===void 0&&(St=new Ed,G[rt]=St),St.getGripSpace()},this.getHand=function(rt){let St=G[rt];return St===void 0&&(St=new Ed,G[rt]=St),St.getHandSpace()};function X(rt){const St=U.indexOf(rt.inputSource);if(St===-1)return;const bt=G[St];bt!==void 0&&(bt.update(rt.inputSource,rt.frame,h||d),bt.dispatchEvent({type:rt.type,data:rt.inputSource}))}function O(){l.removeEventListener("select",X),l.removeEventListener("selectstart",X),l.removeEventListener("selectend",X),l.removeEventListener("squeeze",X),l.removeEventListener("squeezestart",X),l.removeEventListener("squeezeend",X),l.removeEventListener("end",O),l.removeEventListener("inputsourceschange",z);for(let rt=0;rt<G.length;rt++){const St=U[rt];St!==null&&(U[rt]=null,G[rt].disconnect(St))}lt=null,ut=null,y.reset();for(const rt in S)delete S[rt];e.setRenderTarget(N),M=null,g=null,v=null,l=null,P=null,Dt.stop(),s.isPresenting=!1,e.setPixelRatio(T),e.setSize(F.width,F.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(rt){c=rt,s.isPresenting===!0&&$t("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(rt){p=rt,s.isPresenting===!0&&$t("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return h||d},this.setReferenceSpace=function(rt){h=rt},this.getBaseLayer=function(){return g!==null?g:M},this.getBinding=function(){return v===null&&w&&(v=new XRWebGLBinding(l,i)),v},this.getFrame=function(){return b},this.getSession=function(){return l},this.setSession=async function(rt){if(l=rt,l!==null){if(N=e.getRenderTarget(),l.addEventListener("select",X),l.addEventListener("selectstart",X),l.addEventListener("selectend",X),l.addEventListener("squeeze",X),l.addEventListener("squeezestart",X),l.addEventListener("squeezeend",X),l.addEventListener("end",O),l.addEventListener("inputsourceschange",z),C.xrCompatible!==!0&&await i.makeXRCompatible(),T=e.getPixelRatio(),e.getSize(F),w&&"createProjectionLayer"in XRWebGLBinding.prototype){let bt=null,Ht=null,te=null;C.depth&&(te=C.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,bt=C.stencil?Ps:ya,Ht=C.stencil?jo:qi);const Qt={colorFormat:i.RGBA8,depthFormat:te,scaleFactor:c};v=this.getBinding(),g=v.createProjectionLayer(Qt),l.updateRenderState({layers:[g]}),e.setPixelRatio(1),e.setSize(g.textureWidth,g.textureHeight,!1),P=new Xi(g.textureWidth,g.textureHeight,{format:Ui,type:ci,depthTexture:new Ir(g.textureWidth,g.textureHeight,Ht,void 0,void 0,void 0,void 0,void 0,void 0,bt),stencilBuffer:C.stencil,colorSpace:e.outputColorSpace,samples:C.antialias?4:0,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}else{const bt={antialias:C.antialias,alpha:!0,depth:C.depth,stencil:C.stencil,framebufferScaleFactor:c};M=new XRWebGLLayer(l,i,bt),l.updateRenderState({baseLayer:M}),e.setPixelRatio(1),e.setSize(M.framebufferWidth,M.framebufferHeight,!1),P=new Xi(M.framebufferWidth,M.framebufferHeight,{format:Ui,type:ci,colorSpace:e.outputColorSpace,stencilBuffer:C.stencil,resolveDepthBuffer:M.ignoreDepthValues===!1,resolveStencilBuffer:M.ignoreDepthValues===!1})}P.isXRRenderTarget=!0,this.setFoveation(m),h=null,d=await l.requestReferenceSpace(p),Dt.setContext(l),Dt.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function z(rt){for(let St=0;St<rt.removed.length;St++){const bt=rt.removed[St],Ht=U.indexOf(bt);Ht>=0&&(U[Ht]=null,G[Ht].disconnect(bt))}for(let St=0;St<rt.added.length;St++){const bt=rt.added[St];let Ht=U.indexOf(bt);if(Ht===-1){for(let Qt=0;Qt<G.length;Qt++)if(Qt>=U.length){U.push(bt),Ht=Qt;break}else if(U[Qt]===null){U[Qt]=bt,Ht=Qt;break}if(Ht===-1)break}const te=G[Ht];te&&te.connect(bt)}}const ot=new $,gt=new $;function Mt(rt,St,bt){ot.setFromMatrixPosition(St.matrixWorld),gt.setFromMatrixPosition(bt.matrixWorld);const Ht=ot.distanceTo(gt),te=St.projectionMatrix.elements,Qt=bt.projectionMatrix.elements,Xe=te[14]/(te[10]-1),fe=te[14]/(te[10]+1),ve=(te[9]+1)/te[5],Le=(te[9]-1)/te[5],le=(te[8]-1)/te[0],on=(Qt[8]+1)/Qt[0],Ye=Xe*le,En=Xe*on,W=Ht/(-le+on),tn=W*-le;if(St.matrixWorld.decompose(rt.position,rt.quaternion,rt.scale),rt.translateX(tn),rt.translateZ(W),rt.matrixWorld.compose(rt.position,rt.quaternion,rt.scale),rt.matrixWorldInverse.copy(rt.matrixWorld).invert(),te[10]===-1)rt.projectionMatrix.copy(St.projectionMatrix),rt.projectionMatrixInverse.copy(St.projectionMatrixInverse);else{const de=Xe+W,He=fe+W,Rt=Ye-tn,Ke=En+(Ht-tn),D=ve*fe/He*de,E=Le*fe/He*de;rt.projectionMatrix.makePerspective(Rt,Ke,D,E,de,He),rt.projectionMatrixInverse.copy(rt.projectionMatrix).invert()}}function I(rt,St){St===null?rt.matrixWorld.copy(rt.matrix):rt.matrixWorld.multiplyMatrices(St.matrixWorld,rt.matrix),rt.matrixWorldInverse.copy(rt.matrixWorld).invert()}this.updateCamera=function(rt){if(l===null)return;let St=rt.near,bt=rt.far;y.texture!==null&&(y.depthNear>0&&(St=y.depthNear),y.depthFar>0&&(bt=y.depthFar)),K.near=Y.near=L.near=St,K.far=Y.far=L.far=bt,(lt!==K.near||ut!==K.far)&&(l.updateRenderState({depthNear:K.near,depthFar:K.far}),lt=K.near,ut=K.far),K.layers.mask=rt.layers.mask|6,L.layers.mask=K.layers.mask&-5,Y.layers.mask=K.layers.mask&-3;const Ht=rt.parent,te=K.cameras;I(K,Ht);for(let Qt=0;Qt<te.length;Qt++)I(te[Qt],Ht);te.length===2?Mt(K,L,Y):K.projectionMatrix.copy(L.projectionMatrix),J(rt,K,Ht)};function J(rt,St,bt){bt===null?rt.matrix.copy(St.matrixWorld):(rt.matrix.copy(bt.matrixWorld),rt.matrix.invert(),rt.matrix.multiply(St.matrixWorld)),rt.matrix.decompose(rt.position,rt.quaternion,rt.scale),rt.updateMatrixWorld(!0),rt.projectionMatrix.copy(St.projectionMatrix),rt.projectionMatrixInverse.copy(St.projectionMatrixInverse),rt.isPerspectiveCamera&&(rt.fov=zh*2*Math.atan(1/rt.projectionMatrix.elements[5]),rt.zoom=1)}this.getCamera=function(){return K},this.getFoveation=function(){if(!(g===null&&M===null))return m},this.setFoveation=function(rt){m=rt,g!==null&&(g.fixedFoveation=rt),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=rt)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(K)},this.getCameraTexture=function(rt){return S[rt]};let xt=null;function At(rt,St){if(x=St.getViewerPose(h||d),b=St,x!==null){const bt=x.views;M!==null&&(e.setRenderTargetFramebuffer(P,M.framebuffer),e.setRenderTarget(P));let Ht=!1;bt.length!==K.cameras.length&&(K.cameras.length=0,Ht=!0);for(let fe=0;fe<bt.length;fe++){const ve=bt[fe];let Le=null;if(M!==null)Le=M.getViewport(ve);else{const on=v.getViewSubImage(g,ve);Le=on.viewport,fe===0&&(e.setRenderTargetTextures(P,on.colorTexture,on.depthStencilTexture),e.setRenderTarget(P))}let le=H[fe];le===void 0&&(le=new li,le.layers.enable(fe),le.viewport=new sn,H[fe]=le),le.matrix.fromArray(ve.transform.matrix),le.matrix.decompose(le.position,le.quaternion,le.scale),le.projectionMatrix.fromArray(ve.projectionMatrix),le.projectionMatrixInverse.copy(le.projectionMatrix).invert(),le.viewport.set(Le.x,Le.y,Le.width,Le.height),fe===0&&(K.matrix.copy(le.matrix),K.matrix.decompose(K.position,K.quaternion,K.scale)),Ht===!0&&K.cameras.push(le)}const te=l.enabledFeatures;if(te&&te.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&w){v=s.getBinding();const fe=v.getDepthInformation(bt[0]);fe&&fe.isValid&&fe.texture&&y.init(fe,l.renderState)}if(te&&te.includes("camera-access")&&w){e.state.unbindTexture(),v=s.getBinding();for(let fe=0;fe<bt.length;fe++){const ve=bt[fe].camera;if(ve){let Le=S[ve];Le||(Le=new Rv,S[ve]=Le);const le=v.getCameraImage(ve);Le.sourceTexture=le}}}}for(let bt=0;bt<G.length;bt++){const Ht=U[bt],te=G[bt];Ht!==null&&te!==void 0&&te.update(Ht,St,h||d)}xt&&xt(rt,St),St.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:St}),b=null}const Dt=new Uv;Dt.setAnimationLoop(At),this.setAnimationLoop=function(rt){xt=rt},this.dispose=function(){}}}const pA=new rn,zv=new se;zv.set(-1,0,0,0,1,0,0,0,1);function mA(o,e){function i(y,S){y.matrixAutoUpdate===!0&&y.updateMatrix(),S.value.copy(y.matrix)}function s(y,S){S.color.getRGB(y.fogColor.value,Cv(o)),S.isFog?(y.fogNear.value=S.near,y.fogFar.value=S.far):S.isFogExp2&&(y.fogDensity.value=S.density)}function l(y,S,C,N,P){S.isNodeMaterial?S.uniformsNeedUpdate=!1:S.isMeshBasicMaterial?c(y,S):S.isMeshLambertMaterial?(c(y,S),S.envMap&&(y.envMapIntensity.value=S.envMapIntensity)):S.isMeshToonMaterial?(c(y,S),v(y,S)):S.isMeshPhongMaterial?(c(y,S),x(y,S),S.envMap&&(y.envMapIntensity.value=S.envMapIntensity)):S.isMeshStandardMaterial?(c(y,S),g(y,S),S.isMeshPhysicalMaterial&&M(y,S,P)):S.isMeshMatcapMaterial?(c(y,S),b(y,S)):S.isMeshDepthMaterial?c(y,S):S.isMeshDistanceMaterial?(c(y,S),w(y,S)):S.isMeshNormalMaterial?c(y,S):S.isLineBasicMaterial?(d(y,S),S.isLineDashedMaterial&&p(y,S)):S.isPointsMaterial?m(y,S,C,N):S.isSpriteMaterial?h(y,S):S.isShadowMaterial?(y.color.value.copy(S.color),y.opacity.value=S.opacity):S.isShaderMaterial&&(S.uniformsNeedUpdate=!1)}function c(y,S){y.opacity.value=S.opacity,S.color&&y.diffuse.value.copy(S.color),S.emissive&&y.emissive.value.copy(S.emissive).multiplyScalar(S.emissiveIntensity),S.map&&(y.map.value=S.map,i(S.map,y.mapTransform)),S.alphaMap&&(y.alphaMap.value=S.alphaMap,i(S.alphaMap,y.alphaMapTransform)),S.bumpMap&&(y.bumpMap.value=S.bumpMap,i(S.bumpMap,y.bumpMapTransform),y.bumpScale.value=S.bumpScale,S.side===jn&&(y.bumpScale.value*=-1)),S.normalMap&&(y.normalMap.value=S.normalMap,i(S.normalMap,y.normalMapTransform),y.normalScale.value.copy(S.normalScale),S.side===jn&&y.normalScale.value.negate()),S.displacementMap&&(y.displacementMap.value=S.displacementMap,i(S.displacementMap,y.displacementMapTransform),y.displacementScale.value=S.displacementScale,y.displacementBias.value=S.displacementBias),S.emissiveMap&&(y.emissiveMap.value=S.emissiveMap,i(S.emissiveMap,y.emissiveMapTransform)),S.specularMap&&(y.specularMap.value=S.specularMap,i(S.specularMap,y.specularMapTransform)),S.alphaTest>0&&(y.alphaTest.value=S.alphaTest);const C=e.get(S),N=C.envMap,P=C.envMapRotation;N&&(y.envMap.value=N,y.envMapRotation.value.setFromMatrix4(pA.makeRotationFromEuler(P)).transpose(),N.isCubeTexture&&N.isRenderTargetTexture===!1&&y.envMapRotation.value.premultiply(zv),y.reflectivity.value=S.reflectivity,y.ior.value=S.ior,y.refractionRatio.value=S.refractionRatio),S.lightMap&&(y.lightMap.value=S.lightMap,y.lightMapIntensity.value=S.lightMapIntensity,i(S.lightMap,y.lightMapTransform)),S.aoMap&&(y.aoMap.value=S.aoMap,y.aoMapIntensity.value=S.aoMapIntensity,i(S.aoMap,y.aoMapTransform))}function d(y,S){y.diffuse.value.copy(S.color),y.opacity.value=S.opacity,S.map&&(y.map.value=S.map,i(S.map,y.mapTransform))}function p(y,S){y.dashSize.value=S.dashSize,y.totalSize.value=S.dashSize+S.gapSize,y.scale.value=S.scale}function m(y,S,C,N){y.diffuse.value.copy(S.color),y.opacity.value=S.opacity,y.size.value=S.size*C,y.scale.value=N*.5,S.map&&(y.map.value=S.map,i(S.map,y.uvTransform)),S.alphaMap&&(y.alphaMap.value=S.alphaMap,i(S.alphaMap,y.alphaMapTransform)),S.alphaTest>0&&(y.alphaTest.value=S.alphaTest)}function h(y,S){y.diffuse.value.copy(S.color),y.opacity.value=S.opacity,y.rotation.value=S.rotation,S.map&&(y.map.value=S.map,i(S.map,y.mapTransform)),S.alphaMap&&(y.alphaMap.value=S.alphaMap,i(S.alphaMap,y.alphaMapTransform)),S.alphaTest>0&&(y.alphaTest.value=S.alphaTest)}function x(y,S){y.specular.value.copy(S.specular),y.shininess.value=Math.max(S.shininess,1e-4)}function v(y,S){S.gradientMap&&(y.gradientMap.value=S.gradientMap)}function g(y,S){y.metalness.value=S.metalness,S.metalnessMap&&(y.metalnessMap.value=S.metalnessMap,i(S.metalnessMap,y.metalnessMapTransform)),y.roughness.value=S.roughness,S.roughnessMap&&(y.roughnessMap.value=S.roughnessMap,i(S.roughnessMap,y.roughnessMapTransform)),S.envMap&&(y.envMapIntensity.value=S.envMapIntensity)}function M(y,S,C){y.ior.value=S.ior,S.sheen>0&&(y.sheenColor.value.copy(S.sheenColor).multiplyScalar(S.sheen),y.sheenRoughness.value=S.sheenRoughness,S.sheenColorMap&&(y.sheenColorMap.value=S.sheenColorMap,i(S.sheenColorMap,y.sheenColorMapTransform)),S.sheenRoughnessMap&&(y.sheenRoughnessMap.value=S.sheenRoughnessMap,i(S.sheenRoughnessMap,y.sheenRoughnessMapTransform))),S.clearcoat>0&&(y.clearcoat.value=S.clearcoat,y.clearcoatRoughness.value=S.clearcoatRoughness,S.clearcoatMap&&(y.clearcoatMap.value=S.clearcoatMap,i(S.clearcoatMap,y.clearcoatMapTransform)),S.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=S.clearcoatRoughnessMap,i(S.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),S.clearcoatNormalMap&&(y.clearcoatNormalMap.value=S.clearcoatNormalMap,i(S.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(S.clearcoatNormalScale),S.side===jn&&y.clearcoatNormalScale.value.negate())),S.dispersion>0&&(y.dispersion.value=S.dispersion),S.iridescence>0&&(y.iridescence.value=S.iridescence,y.iridescenceIOR.value=S.iridescenceIOR,y.iridescenceThicknessMinimum.value=S.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=S.iridescenceThicknessRange[1],S.iridescenceMap&&(y.iridescenceMap.value=S.iridescenceMap,i(S.iridescenceMap,y.iridescenceMapTransform)),S.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=S.iridescenceThicknessMap,i(S.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),S.transmission>0&&(y.transmission.value=S.transmission,y.transmissionSamplerMap.value=C.texture,y.transmissionSamplerSize.value.set(C.width,C.height),S.transmissionMap&&(y.transmissionMap.value=S.transmissionMap,i(S.transmissionMap,y.transmissionMapTransform)),y.thickness.value=S.thickness,S.thicknessMap&&(y.thicknessMap.value=S.thicknessMap,i(S.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=S.attenuationDistance,y.attenuationColor.value.copy(S.attenuationColor)),S.anisotropy>0&&(y.anisotropyVector.value.set(S.anisotropy*Math.cos(S.anisotropyRotation),S.anisotropy*Math.sin(S.anisotropyRotation)),S.anisotropyMap&&(y.anisotropyMap.value=S.anisotropyMap,i(S.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=S.specularIntensity,y.specularColor.value.copy(S.specularColor),S.specularColorMap&&(y.specularColorMap.value=S.specularColorMap,i(S.specularColorMap,y.specularColorMapTransform)),S.specularIntensityMap&&(y.specularIntensityMap.value=S.specularIntensityMap,i(S.specularIntensityMap,y.specularIntensityMapTransform))}function b(y,S){S.matcap&&(y.matcap.value=S.matcap)}function w(y,S){const C=e.get(S).light;y.referencePosition.value.setFromMatrixPosition(C.matrixWorld),y.nearDistance.value=C.shadow.camera.near,y.farDistance.value=C.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function gA(o,e,i,s){let l={},c={},d=[];const p=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function m(C,N){const P=N.program;s.uniformBlockBinding(C,P)}function h(C,N){let P=l[C.id];P===void 0&&(b(C),P=x(C),l[C.id]=P,C.addEventListener("dispose",y));const G=N.program;s.updateUBOMapping(C,G);const U=e.render.frame;c[C.id]!==U&&(g(C),c[C.id]=U)}function x(C){const N=v();C.__bindingPointIndex=N;const P=o.createBuffer(),G=C.__size,U=C.usage;return o.bindBuffer(o.UNIFORM_BUFFER,P),o.bufferData(o.UNIFORM_BUFFER,G,U),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,N,P),P}function v(){for(let C=0;C<p;C++)if(d.indexOf(C)===-1)return d.push(C),C;return Te("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function g(C){const N=l[C.id],P=C.uniforms,G=C.__cache;o.bindBuffer(o.UNIFORM_BUFFER,N);for(let U=0,F=P.length;U<F;U++){const T=Array.isArray(P[U])?P[U]:[P[U]];for(let L=0,Y=T.length;L<Y;L++){const H=T[L];if(M(H,U,L,G)===!0){const K=H.__offset,lt=Array.isArray(H.value)?H.value:[H.value];let ut=0;for(let X=0;X<lt.length;X++){const O=lt[X],z=w(O);typeof O=="number"||typeof O=="boolean"?(H.__data[0]=O,o.bufferSubData(o.UNIFORM_BUFFER,K+ut,H.__data)):O.isMatrix3?(H.__data[0]=O.elements[0],H.__data[1]=O.elements[1],H.__data[2]=O.elements[2],H.__data[3]=0,H.__data[4]=O.elements[3],H.__data[5]=O.elements[4],H.__data[6]=O.elements[5],H.__data[7]=0,H.__data[8]=O.elements[6],H.__data[9]=O.elements[7],H.__data[10]=O.elements[8],H.__data[11]=0):ArrayBuffer.isView(O)?H.__data.set(new O.constructor(O.buffer,O.byteOffset,H.__data.length)):(O.toArray(H.__data,ut),ut+=z.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,K,H.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function M(C,N,P,G){const U=C.value,F=N+"_"+P;if(G[F]===void 0)return typeof U=="number"||typeof U=="boolean"?G[F]=U:ArrayBuffer.isView(U)?G[F]=U.slice():G[F]=U.clone(),!0;{const T=G[F];if(typeof U=="number"||typeof U=="boolean"){if(T!==U)return G[F]=U,!0}else{if(ArrayBuffer.isView(U))return!0;if(T.equals(U)===!1)return T.copy(U),!0}}return!1}function b(C){const N=C.uniforms;let P=0;const G=16;for(let F=0,T=N.length;F<T;F++){const L=Array.isArray(N[F])?N[F]:[N[F]];for(let Y=0,H=L.length;Y<H;Y++){const K=L[Y],lt=Array.isArray(K.value)?K.value:[K.value];for(let ut=0,X=lt.length;ut<X;ut++){const O=lt[ut],z=w(O),ot=P%G,gt=ot%z.boundary,Mt=ot+gt;P+=gt,Mt!==0&&G-Mt<z.storage&&(P+=G-Mt),K.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),K.__offset=P,P+=z.storage}}}const U=P%G;return U>0&&(P+=G-U),C.__size=P,C.__cache={},this}function w(C){const N={boundary:0,storage:0};return typeof C=="number"||typeof C=="boolean"?(N.boundary=4,N.storage=4):C.isVector2?(N.boundary=8,N.storage=8):C.isVector3||C.isColor?(N.boundary=16,N.storage=12):C.isVector4?(N.boundary=16,N.storage=16):C.isMatrix3?(N.boundary=48,N.storage=48):C.isMatrix4?(N.boundary=64,N.storage=64):C.isTexture?$t("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(C)?(N.boundary=16,N.storage=C.byteLength):$t("WebGLRenderer: Unsupported uniform value type.",C),N}function y(C){const N=C.target;N.removeEventListener("dispose",y);const P=d.indexOf(N.__bindingPointIndex);d.splice(P,1),o.deleteBuffer(l[N.id]),delete l[N.id],delete c[N.id]}function S(){for(const C in l)o.deleteBuffer(l[C]);d=[],l={},c={}}return{bind:m,update:h,dispose:S}}const _A=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let zi=null;function vA(){return zi===null&&(zi=new eM(_A,16,16,Fs,Sa),zi.name="DFG_LUT",zi.minFilter=Fn,zi.magFilter=Fn,zi.wrapS=_a,zi.wrapT=_a,zi.generateMipmaps=!1,zi.needsUpdate=!0),zi}class xA{constructor(e={}){const{canvas:i=Ny(),context:s=null,depth:l=!0,stencil:c=!1,alpha:d=!1,antialias:p=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:h=!1,powerPreference:x="default",failIfMajorPerformanceCaveat:v=!1,reversedDepthBuffer:g=!1,outputBufferType:M=ci}=e;this.isWebGLRenderer=!0;let b;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");b=s.getContextAttributes().alpha}else b=d;const w=M,y=new Set([Qh,Kh,Zh]),S=new Set([ci,qi,Yo,jo,Yh,jh]),C=new Uint32Array(4),N=new Int32Array(4),P=new $;let G=null,U=null;const F=[],T=[];let L=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ki,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const Y=this;let H=!1,K=null;this._outputColorSpace=yi;let lt=0,ut=0,X=null,O=-1,z=null;const ot=new sn,gt=new sn;let Mt=null;const I=new be(0);let J=0,xt=i.width,At=i.height,Dt=1,rt=null,St=null;const bt=new sn(0,0,xt,At),Ht=new sn(0,0,xt,At);let te=!1;const Qt=new ep;let Xe=!1,fe=!1;const ve=new rn,Le=new $,le=new sn,on={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ye=!1;function En(){return X===null?Dt:1}let W=s;function tn(A,q){return i.getContext(A,q)}try{const A={alpha:!0,depth:l,stencil:c,antialias:p,premultipliedAlpha:m,preserveDrawingBuffer:h,powerPreference:x,failIfMajorPerformanceCaveat:v};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Xh}`),i.addEventListener("webglcontextlost",yt,!1),i.addEventListener("webglcontextrestored",qt,!1),i.addEventListener("webglcontextcreationerror",ee,!1),W===null){const q="webgl2";if(W=tn(q,A),W===null)throw tn(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw Te("WebGLRenderer: "+A.message),A}let de,He,Rt,Ke,D,E,Q,_t,Et,Ct,Lt,ft,dt,Ot,Pt,Ut,wt,ne,ie,he,V,Tt,pt;function zt(){de=new vb(W),de.init(),V=new cA(W,de),He=new ub(W,de,e,V),Rt=new oA(W,de),He.reversedDepthBuffer&&g&&Rt.buffers.depth.setReversed(!0),Ke=new yb(W),D=new YT,E=new lA(W,de,Rt,D,He,V,Ke),Q=new _b(Y),_t=new TM(W),Tt=new lb(W,_t),Et=new xb(W,_t,Ke,Tt),Ct=new Eb(W,Et,_t,Tt,Ke),ne=new Mb(W,He,E),Pt=new fb(D),Lt=new qT(Y,Q,de,He,Tt,Pt),ft=new mA(Y,D),dt=new ZT,Ot=new eA(de),wt=new ob(Y,Q,Rt,Ct,b,m),Ut=new rA(Y,Ct,He),pt=new gA(W,Ke,He,Rt),ie=new cb(W,de,Ke),he=new Sb(W,de,Ke),Ke.programs=Lt.programs,Y.capabilities=He,Y.extensions=de,Y.properties=D,Y.renderLists=dt,Y.shadowMap=Ut,Y.state=Rt,Y.info=Ke}zt(),w!==ci&&(L=new Tb(w,i.width,i.height,l,c));const Nt=new hA(Y,W);this.xr=Nt,this.getContext=function(){return W},this.getContextAttributes=function(){return W.getContextAttributes()},this.forceContextLoss=function(){const A=de.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=de.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return Dt},this.setPixelRatio=function(A){A!==void 0&&(Dt=A,this.setSize(xt,At,!1))},this.getSize=function(A){return A.set(xt,At)},this.setSize=function(A,q,at=!0){if(Nt.isPresenting){$t("WebGLRenderer: Can't change size while VR device is presenting.");return}xt=A,At=q,i.width=Math.floor(A*Dt),i.height=Math.floor(q*Dt),at===!0&&(i.style.width=A+"px",i.style.height=q+"px"),L!==null&&L.setSize(i.width,i.height),this.setViewport(0,0,A,q)},this.getDrawingBufferSize=function(A){return A.set(xt*Dt,At*Dt).floor()},this.setDrawingBufferSize=function(A,q,at){xt=A,At=q,Dt=at,i.width=Math.floor(A*at),i.height=Math.floor(q*at),this.setViewport(0,0,A,q)},this.setEffects=function(A){if(w===ci){Te("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let q=0;q<A.length;q++)if(A[q].isOutputPass===!0){$t("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}L.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(ot)},this.getViewport=function(A){return A.copy(bt)},this.setViewport=function(A,q,at,nt){A.isVector4?bt.set(A.x,A.y,A.z,A.w):bt.set(A,q,at,nt),Rt.viewport(ot.copy(bt).multiplyScalar(Dt).round())},this.getScissor=function(A){return A.copy(Ht)},this.setScissor=function(A,q,at,nt){A.isVector4?Ht.set(A.x,A.y,A.z,A.w):Ht.set(A,q,at,nt),Rt.scissor(gt.copy(Ht).multiplyScalar(Dt).round())},this.getScissorTest=function(){return te},this.setScissorTest=function(A){Rt.setScissorTest(te=A)},this.setOpaqueSort=function(A){rt=A},this.setTransparentSort=function(A){St=A},this.getClearColor=function(A){return A.copy(wt.getClearColor())},this.setClearColor=function(){wt.setClearColor(...arguments)},this.getClearAlpha=function(){return wt.getClearAlpha()},this.setClearAlpha=function(){wt.setClearAlpha(...arguments)},this.clear=function(A=!0,q=!0,at=!0){let nt=0;if(A){let it=!1;if(X!==null){const Ft=X.texture.format;it=y.has(Ft)}if(it){const Ft=X.texture.type,Vt=S.has(Ft),It=wt.getClearColor(),Xt=wt.getClearAlpha(),kt=It.r,Zt=It.g,re=It.b;Vt?(C[0]=kt,C[1]=Zt,C[2]=re,C[3]=Xt,W.clearBufferuiv(W.COLOR,0,C)):(N[0]=kt,N[1]=Zt,N[2]=re,N[3]=Xt,W.clearBufferiv(W.COLOR,0,N))}else nt|=W.COLOR_BUFFER_BIT}q&&(nt|=W.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),at&&(nt|=W.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),nt!==0&&W.clear(nt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(A){A.setRenderer(this),K=A},this.dispose=function(){i.removeEventListener("webglcontextlost",yt,!1),i.removeEventListener("webglcontextrestored",qt,!1),i.removeEventListener("webglcontextcreationerror",ee,!1),wt.dispose(),dt.dispose(),Ot.dispose(),D.dispose(),Q.dispose(),Ct.dispose(),Tt.dispose(),pt.dispose(),Lt.dispose(),Nt.dispose(),Nt.removeEventListener("sessionstart",kr),Nt.removeEventListener("sessionend",Xr),Nn.stop()};function yt(A){A.preventDefault(),o_("WebGLRenderer: Context Lost."),H=!0}function qt(){o_("WebGLRenderer: Context Restored."),H=!1;const A=Ke.autoReset,q=Ut.enabled,at=Ut.autoUpdate,nt=Ut.needsUpdate,it=Ut.type;zt(),Ke.autoReset=A,Ut.enabled=q,Ut.autoUpdate=at,Ut.needsUpdate=nt,Ut.type=it}function ee(A){Te("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function en(A){const q=A.target;q.removeEventListener("dispose",en),we(q)}function we(A){fi(A),D.remove(A)}function fi(A){const q=D.get(A).programs;q!==void 0&&(q.forEach(function(at){Lt.releaseProgram(at)}),A.isShaderMaterial&&Lt.releaseShaderCache(A))}this.renderBufferDirect=function(A,q,at,nt,it,Ft){q===null&&(q=on);const Vt=it.isMesh&&it.matrixWorld.determinant()<0,It=Ta(A,q,at,nt,it);Rt.setMaterial(nt,Vt);let Xt=at.index,kt=1;if(nt.wireframe===!0){if(Xt=Et.getWireframeAttribute(at),Xt===void 0)return;kt=2}const Zt=at.drawRange,re=at.attributes.position;let jt=Zt.start*kt,Ae=(Zt.start+Zt.count)*kt;Ft!==null&&(jt=Math.max(jt,Ft.start*kt),Ae=Math.min(Ae,(Ft.start+Ft.count)*kt)),Xt!==null?(jt=Math.max(jt,0),Ae=Math.min(Ae,Xt.count)):re!=null&&(jt=Math.max(jt,0),Ae=Math.min(Ae,re.count));const Qe=Ae-jt;if(Qe<0||Qe===1/0)return;Tt.setup(it,nt,It,at,Xt);let We,Oe=ie;if(Xt!==null&&(We=_t.get(Xt),Oe=he,Oe.setIndex(We)),it.isMesh)nt.wireframe===!0?(Rt.setLineWidth(nt.wireframeLinewidth*En()),Oe.setMode(W.LINES)):Oe.setMode(W.TRIANGLES);else if(it.isLine){let Pe=nt.linewidth;Pe===void 0&&(Pe=1),Rt.setLineWidth(Pe*En()),it.isLineSegments?Oe.setMode(W.LINES):it.isLineLoop?Oe.setMode(W.LINE_LOOP):Oe.setMode(W.LINE_STRIP)}else it.isPoints?Oe.setMode(W.POINTS):it.isSprite&&Oe.setMode(W.TRIANGLES);if(it.isBatchedMesh)if(de.get("WEBGL_multi_draw"))Oe.renderMultiDraw(it._multiDrawStarts,it._multiDrawCounts,it._multiDrawCount);else{const Pe=it._multiDrawStarts,Gt=it._multiDrawCounts,Ln=it._multiDrawCount,pe=Xt?_t.get(Xt).bytesPerElement:1,_n=D.get(nt).currentProgram.getUniforms();for(let Qn=0;Qn<Ln;Qn++)_n.setValue(W,"_gl_DrawID",Qn),Oe.render(Pe[Qn]/pe,Gt[Qn])}else if(it.isInstancedMesh)Oe.renderInstances(jt,Qe,it.count);else if(at.isInstancedBufferGeometry){const Pe=at._maxInstanceCount!==void 0?at._maxInstanceCount:1/0,Gt=Math.min(at.instanceCount,Pe);Oe.renderInstances(jt,Qe,Gt)}else Oe.render(jt,Qe)};function Kn(A,q,at){A.transparent===!0&&A.side===Hi&&A.forceSinglePass===!1?(A.side=jn,A.needsUpdate=!0,Bs(A,q,at),A.side=rs,A.needsUpdate=!0,Bs(A,q,at),A.side=Hi):Bs(A,q,at)}this.compile=function(A,q,at=null){at===null&&(at=A),U=Ot.get(at),U.init(q),T.push(U),at.traverseVisible(function(it){it.isLight&&it.layers.test(q.layers)&&(U.pushLight(it),it.castShadow&&U.pushShadow(it))}),A!==at&&A.traverseVisible(function(it){it.isLight&&it.layers.test(q.layers)&&(U.pushLight(it),it.castShadow&&U.pushShadow(it))}),U.setupLights();const nt=new Set;return A.traverse(function(it){if(!(it.isMesh||it.isPoints||it.isLine||it.isSprite))return;const Ft=it.material;if(Ft)if(Array.isArray(Ft))for(let Vt=0;Vt<Ft.length;Vt++){const It=Ft[Vt];Kn(It,at,it),nt.add(It)}else Kn(Ft,at,it),nt.add(Ft)}),U=T.pop(),nt},this.compileAsync=function(A,q,at=null){const nt=this.compile(A,q,at);return new Promise(it=>{function Ft(){if(nt.forEach(function(Vt){D.get(Vt).currentProgram.isReady()&&nt.delete(Vt)}),nt.size===0){it(A);return}setTimeout(Ft,10)}de.get("KHR_parallel_shader_compile")!==null?Ft():setTimeout(Ft,10)})};let ls=null;function Vr(A){ls&&ls(A)}function kr(){Nn.stop()}function Xr(){Nn.start()}const Nn=new Uv;Nn.setAnimationLoop(Vr),typeof self<"u"&&Nn.setContext(self),this.setAnimationLoop=function(A){ls=A,Nt.setAnimationLoop(A),A===null?Nn.stop():Nn.start()},Nt.addEventListener("sessionstart",kr),Nt.addEventListener("sessionend",Xr),this.render=function(A,q){if(q!==void 0&&q.isCamera!==!0){Te("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(H===!0)return;K!==null&&K.renderStart(A,q);const at=Nt.enabled===!0&&Nt.isPresenting===!0,nt=L!==null&&(X===null||at)&&L.begin(Y,X);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),Nt.enabled===!0&&Nt.isPresenting===!0&&(L===null||L.isCompositing()===!1)&&(Nt.cameraAutoUpdate===!0&&Nt.updateCamera(q),q=Nt.getCamera()),A.isScene===!0&&A.onBeforeRender(Y,A,q,X),U=Ot.get(A,T.length),U.init(q),U.state.textureUnits=E.getTextureUnits(),T.push(U),ve.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Qt.setFromProjectionMatrix(ve,Vi,q.reversedDepth),fe=this.localClippingEnabled,Xe=Pt.init(this.clippingPlanes,fe),G=dt.get(A,F.length),G.init(),F.push(G),Nt.enabled===!0&&Nt.isPresenting===!0){const Vt=Y.xr.getDepthSensingMesh();Vt!==null&&ln(Vt,q,-1/0,Y.sortObjects)}ln(A,q,0,Y.sortObjects),G.finish(),Y.sortObjects===!0&&G.sort(rt,St),Ye=Nt.enabled===!1||Nt.isPresenting===!1||Nt.hasDepthSensing()===!1,Ye&&wt.addToRenderList(G,A),this.info.render.frame++,Xe===!0&&Pt.beginShadows();const it=U.state.shadowsArray;if(Ut.render(it,A,q),Xe===!0&&Pt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(nt&&L.hasRenderPass())===!1){const Vt=G.opaque,It=G.transmissive;if(U.setupLights(),q.isArrayCamera){const Xt=q.cameras;if(It.length>0)for(let kt=0,Zt=Xt.length;kt<Zt;kt++){const re=Xt[kt];ji(Vt,It,A,re)}Ye&&wt.render(A);for(let kt=0,Zt=Xt.length;kt<Zt;kt++){const re=Xt[kt];bn(G,A,re,re.viewport)}}else It.length>0&&ji(Vt,It,A,q),Ye&&wt.render(A),bn(G,A,q)}X!==null&&ut===0&&(E.updateMultisampleRenderTarget(X),E.updateRenderTargetMipmap(X)),nt&&L.end(Y),A.isScene===!0&&A.onAfterRender(Y,A,q),Tt.resetDefaultState(),O=-1,z=null,T.pop(),T.length>0?(U=T[T.length-1],E.setTextureUnits(U.state.textureUnits),Xe===!0&&Pt.setGlobalState(Y.clippingPlanes,U.state.camera)):U=null,F.pop(),F.length>0?G=F[F.length-1]:G=null,K!==null&&K.renderEnd()};function ln(A,q,at,nt){if(A.visible===!1)return;if(A.layers.test(q.layers)){if(A.isGroup)at=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(q);else if(A.isLightProbeGrid)U.pushLightProbeGrid(A);else if(A.isLight)U.pushLight(A),A.castShadow&&U.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Qt.intersectsSprite(A)){nt&&le.setFromMatrixPosition(A.matrixWorld).applyMatrix4(ve);const Vt=Ct.update(A),It=A.material;It.visible&&G.push(A,Vt,It,at,le.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Qt.intersectsObject(A))){const Vt=Ct.update(A),It=A.material;if(nt&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),le.copy(A.boundingSphere.center)):(Vt.boundingSphere===null&&Vt.computeBoundingSphere(),le.copy(Vt.boundingSphere.center)),le.applyMatrix4(A.matrixWorld).applyMatrix4(ve)),Array.isArray(It)){const Xt=Vt.groups;for(let kt=0,Zt=Xt.length;kt<Zt;kt++){const re=Xt[kt],jt=It[re.materialIndex];jt&&jt.visible&&G.push(A,Vt,jt,at,le.z,re)}}else It.visible&&G.push(A,Vt,It,at,le.z,null)}}const Ft=A.children;for(let Vt=0,It=Ft.length;Vt<It;Vt++)ln(Ft[Vt],q,at,nt)}function bn(A,q,at,nt){const{opaque:it,transmissive:Ft,transparent:Vt}=A;U.setupLightsView(at),Xe===!0&&Pt.setGlobalState(Y.clippingPlanes,at),nt&&Rt.viewport(ot.copy(nt)),it.length>0&&Ea(it,q,at),Ft.length>0&&Ea(Ft,q,at),Vt.length>0&&Ea(Vt,q,at),Rt.buffers.depth.setTest(!0),Rt.buffers.depth.setMask(!0),Rt.buffers.color.setMask(!0),Rt.setPolygonOffset(!1)}function ji(A,q,at,nt){if((at.isScene===!0?at.overrideMaterial:null)!==null)return;if(U.state.transmissionRenderTarget[nt.id]===void 0){const jt=de.has("EXT_color_buffer_half_float")||de.has("EXT_color_buffer_float");U.state.transmissionRenderTarget[nt.id]=new Xi(1,1,{generateMipmaps:!0,type:jt?Sa:ci,minFilter:Os,samples:Math.max(4,He.samples),stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Me.workingColorSpace})}const Ft=U.state.transmissionRenderTarget[nt.id],Vt=nt.viewport||ot;Ft.setSize(Vt.z*Y.transmissionResolutionScale,Vt.w*Y.transmissionResolutionScale);const It=Y.getRenderTarget(),Xt=Y.getActiveCubeFace(),kt=Y.getActiveMipmapLevel();Y.setRenderTarget(Ft),Y.getClearColor(I),J=Y.getClearAlpha(),J<1&&Y.setClearColor(16777215,.5),Y.clear(),Ye&&wt.render(at);const Zt=Y.toneMapping;Y.toneMapping=ki;const re=nt.viewport;if(nt.viewport!==void 0&&(nt.viewport=void 0),U.setupLightsView(nt),Xe===!0&&Pt.setGlobalState(Y.clippingPlanes,nt),Ea(A,at,nt),E.updateMultisampleRenderTarget(Ft),E.updateRenderTargetMipmap(Ft),de.has("WEBGL_multisampled_render_to_texture")===!1){let jt=!1;for(let Ae=0,Qe=q.length;Ae<Qe;Ae++){const We=q[Ae],{object:Oe,geometry:Pe,material:Gt,group:Ln}=We;if(Gt.side===Hi&&Oe.layers.test(nt.layers)){const pe=Gt.side;Gt.side=jn,Gt.needsUpdate=!0,tl(Oe,at,nt,Pe,Gt,Ln),Gt.side=pe,Gt.needsUpdate=!0,jt=!0}}jt===!0&&(E.updateMultisampleRenderTarget(Ft),E.updateRenderTargetMipmap(Ft))}Y.setRenderTarget(It,Xt,kt),Y.setClearColor(I,J),re!==void 0&&(nt.viewport=re),Y.toneMapping=Zt}function Ea(A,q,at){const nt=q.isScene===!0?q.overrideMaterial:null;for(let it=0,Ft=A.length;it<Ft;it++){const Vt=A[it],{object:It,geometry:Xt,group:kt}=Vt;let Zt=Vt.material;Zt.allowOverride===!0&&nt!==null&&(Zt=nt),It.layers.test(at.layers)&&tl(It,q,at,Xt,Zt,kt)}}function tl(A,q,at,nt,it,Ft){A.onBeforeRender(Y,q,at,nt,it,Ft),A.modelViewMatrix.multiplyMatrices(at.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),it.onBeforeRender(Y,q,at,nt,A,Ft),it.transparent===!0&&it.side===Hi&&it.forceSinglePass===!1?(it.side=jn,it.needsUpdate=!0,Y.renderBufferDirect(at,q,nt,it,A,Ft),it.side=rs,it.needsUpdate=!0,Y.renderBufferDirect(at,q,nt,it,A,Ft),it.side=Hi):Y.renderBufferDirect(at,q,nt,it,A,Ft),A.onAfterRender(Y,q,at,nt,it,Ft)}function Bs(A,q,at){q.isScene!==!0&&(q=on);const nt=D.get(A),it=U.state.lights,Ft=U.state.shadowsArray,Vt=it.state.version,It=Lt.getParameters(A,it.state,Ft,q,at,U.state.lightProbeGridArray),Xt=Lt.getProgramCacheKey(It);let kt=nt.programs;nt.environment=A.isMeshStandardMaterial||A.isMeshLambertMaterial||A.isMeshPhongMaterial?q.environment:null,nt.fog=q.fog;const Zt=A.isMeshStandardMaterial||A.isMeshLambertMaterial&&!A.envMap||A.isMeshPhongMaterial&&!A.envMap;nt.envMap=Q.get(A.envMap||nt.environment,Zt),nt.envMapRotation=nt.environment!==null&&A.envMap===null?q.environmentRotation:A.envMapRotation,kt===void 0&&(A.addEventListener("dispose",en),kt=new Map,nt.programs=kt);let re=kt.get(Xt);if(re!==void 0){if(nt.currentProgram===re&&nt.lightsStateVersion===Vt)return ba(A,It),re}else It.uniforms=Lt.getUniforms(A),K!==null&&A.isNodeMaterial&&K.build(A,at,It),A.onBeforeCompile(It,Y),re=Lt.acquireProgram(It,Xt),kt.set(Xt,re),nt.uniforms=It.uniforms;const jt=nt.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(jt.clippingPlanes=Pt.uniform),ba(A,It),nt.needsLights=cs(A),nt.lightsStateVersion=Vt,nt.needsLights&&(jt.ambientLightColor.value=it.state.ambient,jt.lightProbe.value=it.state.probe,jt.directionalLights.value=it.state.directional,jt.directionalLightShadows.value=it.state.directionalShadow,jt.spotLights.value=it.state.spot,jt.spotLightShadows.value=it.state.spotShadow,jt.rectAreaLights.value=it.state.rectArea,jt.ltc_1.value=it.state.rectAreaLTC1,jt.ltc_2.value=it.state.rectAreaLTC2,jt.pointLights.value=it.state.point,jt.pointLightShadows.value=it.state.pointShadow,jt.hemisphereLights.value=it.state.hemi,jt.directionalShadowMatrix.value=it.state.directionalShadowMatrix,jt.spotLightMatrix.value=it.state.spotLightMatrix,jt.spotLightMap.value=it.state.spotLightMap,jt.pointShadowMatrix.value=it.state.pointShadowMatrix),nt.lightProbeGrid=U.state.lightProbeGridArray.length>0,nt.currentProgram=re,nt.uniformsList=null,re}function Wr(A){if(A.uniformsList===null){const q=A.currentProgram.getUniforms();A.uniformsList=kc.seqWithValue(q.seq,A.uniforms)}return A.uniformsList}function ba(A,q){const at=D.get(A);at.outputColorSpace=q.outputColorSpace,at.batching=q.batching,at.batchingColor=q.batchingColor,at.instancing=q.instancing,at.instancingColor=q.instancingColor,at.instancingMorph=q.instancingMorph,at.skinning=q.skinning,at.morphTargets=q.morphTargets,at.morphNormals=q.morphNormals,at.morphColors=q.morphColors,at.morphTargetsCount=q.morphTargetsCount,at.numClippingPlanes=q.numClippingPlanes,at.numIntersection=q.numClipIntersection,at.vertexAlphas=q.vertexAlphas,at.vertexTangents=q.vertexTangents,at.toneMapping=q.toneMapping}function qr(A,q){if(A.length===0)return null;if(A.length===1)return A[0].texture!==null?A[0]:null;P.setFromMatrixPosition(q.matrixWorld);for(let at=0,nt=A.length;at<nt;at++){const it=A[at];if(it.texture!==null&&it.boundingBox.containsPoint(P))return it}return null}function Ta(A,q,at,nt,it){q.isScene!==!0&&(q=on),E.resetTextureUnits();const Ft=q.fog,Vt=nt.isMeshStandardMaterial||nt.isMeshLambertMaterial||nt.isMeshPhongMaterial?q.environment:null,It=X===null?Y.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:Me.workingColorSpace,Xt=nt.isMeshStandardMaterial||nt.isMeshLambertMaterial&&!nt.envMap||nt.isMeshPhongMaterial&&!nt.envMap,kt=Q.get(nt.envMap||Vt,Xt),Zt=nt.vertexColors===!0&&!!at.attributes.color&&at.attributes.color.itemSize===4,re=!!at.attributes.tangent&&(!!nt.normalMap||nt.anisotropy>0),jt=!!at.morphAttributes.position,Ae=!!at.morphAttributes.normal,Qe=!!at.morphAttributes.color;let We=ki;nt.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(We=Y.toneMapping);const Oe=at.morphAttributes.position||at.morphAttributes.normal||at.morphAttributes.color,Pe=Oe!==void 0?Oe.length:0,Gt=D.get(nt),Ln=U.state.lights;if(Xe===!0&&(fe===!0||A!==z)){const Ne=A===z&&nt.id===O;Pt.setState(nt,A,Ne)}let pe=!1;nt.version===Gt.__version?(Gt.needsLights&&Gt.lightsStateVersion!==Ln.state.version||Gt.outputColorSpace!==It||it.isBatchedMesh&&Gt.batching===!1||!it.isBatchedMesh&&Gt.batching===!0||it.isBatchedMesh&&Gt.batchingColor===!0&&it.colorTexture===null||it.isBatchedMesh&&Gt.batchingColor===!1&&it.colorTexture!==null||it.isInstancedMesh&&Gt.instancing===!1||!it.isInstancedMesh&&Gt.instancing===!0||it.isSkinnedMesh&&Gt.skinning===!1||!it.isSkinnedMesh&&Gt.skinning===!0||it.isInstancedMesh&&Gt.instancingColor===!0&&it.instanceColor===null||it.isInstancedMesh&&Gt.instancingColor===!1&&it.instanceColor!==null||it.isInstancedMesh&&Gt.instancingMorph===!0&&it.morphTexture===null||it.isInstancedMesh&&Gt.instancingMorph===!1&&it.morphTexture!==null||Gt.envMap!==kt||nt.fog===!0&&Gt.fog!==Ft||Gt.numClippingPlanes!==void 0&&(Gt.numClippingPlanes!==Pt.numPlanes||Gt.numIntersection!==Pt.numIntersection)||Gt.vertexAlphas!==Zt||Gt.vertexTangents!==re||Gt.morphTargets!==jt||Gt.morphNormals!==Ae||Gt.morphColors!==Qe||Gt.toneMapping!==We||Gt.morphTargetsCount!==Pe||!!Gt.lightProbeGrid!=U.state.lightProbeGridArray.length>0)&&(pe=!0):(pe=!0,Gt.__version=nt.version);let _n=Gt.currentProgram;pe===!0&&(_n=Bs(nt,q,it),K&&nt.isNodeMaterial&&K.onUpdateProgram(nt,_n,Gt));let Qn=!1,Ei=!1,Jn=!1;const Ie=_n.getUniforms(),Je=Gt.uniforms;if(Rt.useProgram(_n.program)&&(Qn=!0,Ei=!0,Jn=!0),nt.id!==O&&(O=nt.id,Ei=!0),Gt.needsLights){const Ne=qr(U.state.lightProbeGridArray,it);Gt.lightProbeGrid!==Ne&&(Gt.lightProbeGrid=Ne,Ei=!0)}if(Qn||z!==A){Rt.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),Ie.setValue(W,"projectionMatrix",A.projectionMatrix),Ie.setValue(W,"viewMatrix",A.matrixWorldInverse);const Ni=Ie.map.cameraPosition;Ni!==void 0&&Ni.setValue(W,Le.setFromMatrixPosition(A.matrixWorld)),He.logarithmicDepthBuffer&&Ie.setValue(W,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(nt.isMeshPhongMaterial||nt.isMeshToonMaterial||nt.isMeshLambertMaterial||nt.isMeshBasicMaterial||nt.isMeshStandardMaterial||nt.isShaderMaterial)&&Ie.setValue(W,"isOrthographic",A.isOrthographicCamera===!0),z!==A&&(z=A,Ei=!0,Jn=!0)}if(Gt.needsLights&&(Ln.state.directionalShadowMap.length>0&&Ie.setValue(W,"directionalShadowMap",Ln.state.directionalShadowMap,E),Ln.state.spotShadowMap.length>0&&Ie.setValue(W,"spotShadowMap",Ln.state.spotShadowMap,E),Ln.state.pointShadowMap.length>0&&Ie.setValue(W,"pointShadowMap",Ln.state.pointShadowMap,E)),it.isSkinnedMesh){Ie.setOptional(W,it,"bindMatrix"),Ie.setOptional(W,it,"bindMatrixInverse");const Ne=it.skeleton;Ne&&(Ne.boneTexture===null&&Ne.computeBoneTexture(),Ie.setValue(W,"boneTexture",Ne.boneTexture,E))}it.isBatchedMesh&&(Ie.setOptional(W,it,"batchingTexture"),Ie.setValue(W,"batchingTexture",it._matricesTexture,E),Ie.setOptional(W,it,"batchingIdTexture"),Ie.setValue(W,"batchingIdTexture",it._indirectTexture,E),Ie.setOptional(W,it,"batchingColorTexture"),it._colorsTexture!==null&&Ie.setValue(W,"batchingColorTexture",it._colorsTexture,E));const bi=at.morphAttributes;if((bi.position!==void 0||bi.normal!==void 0||bi.color!==void 0)&&ne.update(it,at,_n),(Ei||Gt.receiveShadow!==it.receiveShadow)&&(Gt.receiveShadow=it.receiveShadow,Ie.setValue(W,"receiveShadow",it.receiveShadow)),(nt.isMeshStandardMaterial||nt.isMeshLambertMaterial||nt.isMeshPhongMaterial)&&nt.envMap===null&&q.environment!==null&&(Je.envMapIntensity.value=q.environmentIntensity),Je.dfgLUT!==void 0&&(Je.dfgLUT.value=vA()),Ei){if(Ie.setValue(W,"toneMappingExposure",Y.toneMappingExposure),Gt.needsLights&&Aa(Je,Jn),Ft&&nt.fog===!0&&ft.refreshFogUniforms(Je,Ft),ft.refreshMaterialUniforms(Je,nt,Dt,At,U.state.transmissionRenderTarget[A.id]),Gt.needsLights&&Gt.lightProbeGrid){const Ne=Gt.lightProbeGrid;Je.probesSH.value=Ne.texture,Je.probesMin.value.copy(Ne.boundingBox.min),Je.probesMax.value.copy(Ne.boundingBox.max),Je.probesResolution.value.copy(Ne.resolution)}kc.upload(W,Wr(Gt),Je,E)}if(nt.isShaderMaterial&&nt.uniformsNeedUpdate===!0&&(kc.upload(W,Wr(Gt),Je,E),nt.uniformsNeedUpdate=!1),nt.isSpriteMaterial&&Ie.setValue(W,"center",it.center),Ie.setValue(W,"modelViewMatrix",it.modelViewMatrix),Ie.setValue(W,"normalMatrix",it.normalMatrix),Ie.setValue(W,"modelMatrix",it.matrixWorld),nt.uniformsGroups!==void 0){const Ne=nt.uniformsGroups;for(let Ni=0,Ca=Ne.length;Ni<Ca;Ni++){const us=Ne[Ni];pt.update(us,_n),pt.bind(us,_n)}}return _n}function Aa(A,q){A.ambientLightColor.needsUpdate=q,A.lightProbe.needsUpdate=q,A.directionalLights.needsUpdate=q,A.directionalLightShadows.needsUpdate=q,A.pointLights.needsUpdate=q,A.pointLightShadows.needsUpdate=q,A.spotLights.needsUpdate=q,A.spotLightShadows.needsUpdate=q,A.rectAreaLights.needsUpdate=q,A.hemisphereLights.needsUpdate=q}function cs(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return lt},this.getActiveMipmapLevel=function(){return ut},this.getRenderTarget=function(){return X},this.setRenderTargetTextures=function(A,q,at){const nt=D.get(A);nt.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,nt.__autoAllocateDepthBuffer===!1&&(nt.__useRenderToTexture=!1),D.get(A.texture).__webglTexture=q,D.get(A.depthTexture).__webglTexture=nt.__autoAllocateDepthBuffer?void 0:at,nt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,q){const at=D.get(A);at.__webglFramebuffer=q,at.__useDefaultFramebuffer=q===void 0};const Ra=W.createFramebuffer();this.setRenderTarget=function(A,q=0,at=0){X=A,lt=q,ut=at;let nt=null,it=!1,Ft=!1;if(A){const It=D.get(A);if(It.__useDefaultFramebuffer!==void 0){Rt.bindFramebuffer(W.FRAMEBUFFER,It.__webglFramebuffer),ot.copy(A.viewport),gt.copy(A.scissor),Mt=A.scissorTest,Rt.viewport(ot),Rt.scissor(gt),Rt.setScissorTest(Mt),O=-1;return}else if(It.__webglFramebuffer===void 0)E.setupRenderTarget(A);else if(It.__hasExternalTextures)E.rebindTextures(A,D.get(A.texture).__webglTexture,D.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Zt=A.depthTexture;if(It.__boundDepthTexture!==Zt){if(Zt!==null&&D.has(Zt)&&(A.width!==Zt.image.width||A.height!==Zt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");E.setupDepthRenderbuffer(A)}}const Xt=A.texture;(Xt.isData3DTexture||Xt.isDataArrayTexture||Xt.isCompressedArrayTexture)&&(Ft=!0);const kt=D.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(kt[q])?nt=kt[q][at]:nt=kt[q],it=!0):A.samples>0&&E.useMultisampledRTT(A)===!1?nt=D.get(A).__webglMultisampledFramebuffer:Array.isArray(kt)?nt=kt[at]:nt=kt,ot.copy(A.viewport),gt.copy(A.scissor),Mt=A.scissorTest}else ot.copy(bt).multiplyScalar(Dt).floor(),gt.copy(Ht).multiplyScalar(Dt).floor(),Mt=te;if(at!==0&&(nt=Ra),Rt.bindFramebuffer(W.FRAMEBUFFER,nt)&&Rt.drawBuffers(A,nt),Rt.viewport(ot),Rt.scissor(gt),Rt.setScissorTest(Mt),it){const It=D.get(A.texture);W.framebufferTexture2D(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_CUBE_MAP_POSITIVE_X+q,It.__webglTexture,at)}else if(Ft){const It=q;for(let Xt=0;Xt<A.textures.length;Xt++){const kt=D.get(A.textures[Xt]);W.framebufferTextureLayer(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0+Xt,kt.__webglTexture,at,It)}}else if(A!==null&&at!==0){const It=D.get(A.texture);W.framebufferTexture2D(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,It.__webglTexture,at)}O=-1},this.readRenderTargetPixels=function(A,q,at,nt,it,Ft,Vt,It=0){if(!(A&&A.isWebGLRenderTarget)){Te("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Xt=D.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Vt!==void 0&&(Xt=Xt[Vt]),Xt){Rt.bindFramebuffer(W.FRAMEBUFFER,Xt);try{const kt=A.textures[It],Zt=kt.format,re=kt.type;if(A.textures.length>1&&W.readBuffer(W.COLOR_ATTACHMENT0+It),!He.textureFormatReadable(Zt)){Te("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!He.textureTypeReadable(re)){Te("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=A.width-nt&&at>=0&&at<=A.height-it&&W.readPixels(q,at,nt,it,V.convert(Zt),V.convert(re),Ft)}finally{const kt=X!==null?D.get(X).__webglFramebuffer:null;Rt.bindFramebuffer(W.FRAMEBUFFER,kt)}}},this.readRenderTargetPixelsAsync=async function(A,q,at,nt,it,Ft,Vt,It=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Xt=D.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Vt!==void 0&&(Xt=Xt[Vt]),Xt)if(q>=0&&q<=A.width-nt&&at>=0&&at<=A.height-it){Rt.bindFramebuffer(W.FRAMEBUFFER,Xt);const kt=A.textures[It],Zt=kt.format,re=kt.type;if(A.textures.length>1&&W.readBuffer(W.COLOR_ATTACHMENT0+It),!He.textureFormatReadable(Zt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!He.textureTypeReadable(re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const jt=W.createBuffer();W.bindBuffer(W.PIXEL_PACK_BUFFER,jt),W.bufferData(W.PIXEL_PACK_BUFFER,Ft.byteLength,W.STREAM_READ),W.readPixels(q,at,nt,it,V.convert(Zt),V.convert(re),0);const Ae=X!==null?D.get(X).__webglFramebuffer:null;Rt.bindFramebuffer(W.FRAMEBUFFER,Ae);const Qe=W.fenceSync(W.SYNC_GPU_COMMANDS_COMPLETE,0);return W.flush(),await Ly(W,Qe,4),W.bindBuffer(W.PIXEL_PACK_BUFFER,jt),W.getBufferSubData(W.PIXEL_PACK_BUFFER,0,Ft),W.deleteBuffer(jt),W.deleteSync(Qe),Ft}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,q=null,at=0){const nt=Math.pow(2,-at),it=Math.floor(A.image.width*nt),Ft=Math.floor(A.image.height*nt),Vt=q!==null?q.x:0,It=q!==null?q.y:0;E.setTexture2D(A,0),W.copyTexSubImage2D(W.TEXTURE_2D,at,0,0,Vt,It,it,Ft),Rt.unbindTexture()};const fn=W.createFramebuffer(),el=W.createFramebuffer();this.copyTextureToTexture=function(A,q,at=null,nt=null,it=0,Ft=0){let Vt,It,Xt,kt,Zt,re,jt,Ae,Qe;const We=A.isCompressedTexture?A.mipmaps[Ft]:A.image;if(at!==null)Vt=at.max.x-at.min.x,It=at.max.y-at.min.y,Xt=at.isBox3?at.max.z-at.min.z:1,kt=at.min.x,Zt=at.min.y,re=at.isBox3?at.min.z:0;else{const Je=Math.pow(2,-it);Vt=Math.floor(We.width*Je),It=Math.floor(We.height*Je),A.isDataArrayTexture?Xt=We.depth:A.isData3DTexture?Xt=Math.floor(We.depth*Je):Xt=1,kt=0,Zt=0,re=0}nt!==null?(jt=nt.x,Ae=nt.y,Qe=nt.z):(jt=0,Ae=0,Qe=0);const Oe=V.convert(q.format),Pe=V.convert(q.type);let Gt;q.isData3DTexture?(E.setTexture3D(q,0),Gt=W.TEXTURE_3D):q.isDataArrayTexture||q.isCompressedArrayTexture?(E.setTexture2DArray(q,0),Gt=W.TEXTURE_2D_ARRAY):(E.setTexture2D(q,0),Gt=W.TEXTURE_2D),Rt.activeTexture(W.TEXTURE0),Rt.pixelStorei(W.UNPACK_FLIP_Y_WEBGL,q.flipY),Rt.pixelStorei(W.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),Rt.pixelStorei(W.UNPACK_ALIGNMENT,q.unpackAlignment);const Ln=Rt.getParameter(W.UNPACK_ROW_LENGTH),pe=Rt.getParameter(W.UNPACK_IMAGE_HEIGHT),_n=Rt.getParameter(W.UNPACK_SKIP_PIXELS),Qn=Rt.getParameter(W.UNPACK_SKIP_ROWS),Ei=Rt.getParameter(W.UNPACK_SKIP_IMAGES);Rt.pixelStorei(W.UNPACK_ROW_LENGTH,We.width),Rt.pixelStorei(W.UNPACK_IMAGE_HEIGHT,We.height),Rt.pixelStorei(W.UNPACK_SKIP_PIXELS,kt),Rt.pixelStorei(W.UNPACK_SKIP_ROWS,Zt),Rt.pixelStorei(W.UNPACK_SKIP_IMAGES,re);const Jn=A.isDataArrayTexture||A.isData3DTexture,Ie=q.isDataArrayTexture||q.isData3DTexture;if(A.isDepthTexture){const Je=D.get(A),bi=D.get(q),Ne=D.get(Je.__renderTarget),Ni=D.get(bi.__renderTarget);Rt.bindFramebuffer(W.READ_FRAMEBUFFER,Ne.__webglFramebuffer),Rt.bindFramebuffer(W.DRAW_FRAMEBUFFER,Ni.__webglFramebuffer);for(let Ca=0;Ca<Xt;Ca++)Jn&&(W.framebufferTextureLayer(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,D.get(A).__webglTexture,it,re+Ca),W.framebufferTextureLayer(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,D.get(q).__webglTexture,Ft,Qe+Ca)),W.blitFramebuffer(kt,Zt,Vt,It,jt,Ae,Vt,It,W.DEPTH_BUFFER_BIT,W.NEAREST);Rt.bindFramebuffer(W.READ_FRAMEBUFFER,null),Rt.bindFramebuffer(W.DRAW_FRAMEBUFFER,null)}else if(it!==0||A.isRenderTargetTexture||D.has(A)){const Je=D.get(A),bi=D.get(q);Rt.bindFramebuffer(W.READ_FRAMEBUFFER,fn),Rt.bindFramebuffer(W.DRAW_FRAMEBUFFER,el);for(let Ne=0;Ne<Xt;Ne++)Jn?W.framebufferTextureLayer(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,Je.__webglTexture,it,re+Ne):W.framebufferTexture2D(W.READ_FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,Je.__webglTexture,it),Ie?W.framebufferTextureLayer(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,bi.__webglTexture,Ft,Qe+Ne):W.framebufferTexture2D(W.DRAW_FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_2D,bi.__webglTexture,Ft),it!==0?W.blitFramebuffer(kt,Zt,Vt,It,jt,Ae,Vt,It,W.COLOR_BUFFER_BIT,W.NEAREST):Ie?W.copyTexSubImage3D(Gt,Ft,jt,Ae,Qe+Ne,kt,Zt,Vt,It):W.copyTexSubImage2D(Gt,Ft,jt,Ae,kt,Zt,Vt,It);Rt.bindFramebuffer(W.READ_FRAMEBUFFER,null),Rt.bindFramebuffer(W.DRAW_FRAMEBUFFER,null)}else Ie?A.isDataTexture||A.isData3DTexture?W.texSubImage3D(Gt,Ft,jt,Ae,Qe,Vt,It,Xt,Oe,Pe,We.data):q.isCompressedArrayTexture?W.compressedTexSubImage3D(Gt,Ft,jt,Ae,Qe,Vt,It,Xt,Oe,We.data):W.texSubImage3D(Gt,Ft,jt,Ae,Qe,Vt,It,Xt,Oe,Pe,We):A.isDataTexture?W.texSubImage2D(W.TEXTURE_2D,Ft,jt,Ae,Vt,It,Oe,Pe,We.data):A.isCompressedTexture?W.compressedTexSubImage2D(W.TEXTURE_2D,Ft,jt,Ae,We.width,We.height,Oe,We.data):W.texSubImage2D(W.TEXTURE_2D,Ft,jt,Ae,Vt,It,Oe,Pe,We);Rt.pixelStorei(W.UNPACK_ROW_LENGTH,Ln),Rt.pixelStorei(W.UNPACK_IMAGE_HEIGHT,pe),Rt.pixelStorei(W.UNPACK_SKIP_PIXELS,_n),Rt.pixelStorei(W.UNPACK_SKIP_ROWS,Qn),Rt.pixelStorei(W.UNPACK_SKIP_IMAGES,Ei),Ft===0&&q.generateMipmaps&&W.generateMipmap(Gt),Rt.unbindTexture()},this.initRenderTarget=function(A){D.get(A).__webglFramebuffer===void 0&&E.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?E.setTextureCube(A,0):A.isData3DTexture?E.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?E.setTexture2DArray(A,0):E.setTexture2D(A,0),Rt.unbindTexture()},this.resetState=function(){lt=0,ut=0,X=null,Rt.reset(),Tt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Vi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=Me._getDrawingBufferColorSpace(e),i.unpackColorSpace=Me._getUnpackColorSpace()}}function SA(){const o=_e.useRef(null),e=_e.useRef(0);return _e.useEffect(()=>{const i=o.current;if(!i)return;const s=new Zy;s.background=new be(462873);const l=new li(52,i.clientWidth/i.clientHeight,.1,500);l.position.set(0,5,38),l.lookAt(0,0,0);const c=new xA({antialias:!0,alpha:!1});c.setSize(i.clientWidth,i.clientHeight),c.setPixelRatio(Math.min(window.devicePixelRatio,1.7)),c.toneMapping=Wh,i.appendChild(c.domElement);const d=new xM(9418960,.55);s.add(d);const p=new vM(16777215,1.3);p.position.set(-10,14,18),s.add(p);const m=new gM(40931,7,80);m.position.set(16,8,18),s.add(m);const h=new EM(70,42,40931,2046280);h.position.y=-8,h.rotation.x=Math.PI*.02,h.material.opacity=.28,h.material.transparent=!0,s.add(h);const x=new Ur,v=new dM({color:793382,metalness:.45,roughness:.55,transparent:!0,opacity:.72}),g=new Kc({color:4944518,transparent:!0,opacity:.45});for(let L=0;L<9;L++){const Y=5+Math.random()*6,H=2.2+Math.random()*3.2,K=new Hr(Y,H,.18),lt=new ui(K,v);lt.position.set(-26+L*6.6,-1+Math.sin(L)*2.8,-9-Math.random()*9),lt.rotation.y=-.22+Math.random()*.42,lt.rotation.x=-.08+Math.random()*.16,x.add(lt);const ut=new Hh(new rM(K),g);ut.position.copy(lt.position),ut.rotation.copy(lt.rotation),x.add(ut)}s.add(x);const M=new Ur,b=new Kc({color:40931,transparent:!0,opacity:.34}),w=new Zc({color:3590399,transparent:!0,opacity:.86}),y=[];for(let L=0;L<8;L++){const Y=-4+L*1.35,H=-2-L*1.4,K=[];for(let ut=0;ut<8;ut++){const X=-26+ut*7.5;K.push(new $(X,Y+Math.sin(ut+L)*.5,H)),ut%2===1&&K.push(new $(X+2.5,Y+1.1,H-.35))}const lt=new Zn().setFromPoints(K);M.add(new Bh(lt,b)),K.filter((ut,X)=>X%3===0).forEach((ut,X)=>{const O=new ui(new np(.09,12,12),w);O.position.copy(ut),M.add(O),y.push({mesh:O,baseScale:1+X*.04,phase:Math.random()*Math.PI*2})})}M.rotation.x=-.12,s.add(M);const S=new Zc({color:40931,transparent:!0,opacity:.12,side:Hi}),C=new ui(new Jo(3.5,48),S);C.position.set(-20,0,2),C.rotation.z=.35,s.add(C);const N={x:0,y:0},P={x:0,y:0},G=L=>{P.x=(L.clientX/window.innerWidth-.5)*2,P.y=(L.clientY/window.innerHeight-.5)*2},U=()=>{const L=i.clientWidth,Y=i.clientHeight;l.aspect=L/Y,l.updateProjectionMatrix(),c.setSize(L,Y)};window.addEventListener("mousemove",G),window.addEventListener("resize",U);const F=new MM,T=()=>{e.current=requestAnimationFrame(T);const L=F.getElapsedTime();N.x+=(P.x-N.x)*.045,N.y+=(P.y-N.y)*.045,l.position.x=N.x*2.2,l.position.y=5-N.y*1.1,l.lookAt(N.x*1.4,-1,0),x.rotation.y=Math.sin(L*.22)*.035,M.position.x=Math.sin(L*.18)*.8,C.position.x=-28+L*6%58,m.position.x=10+Math.sin(L*.5)*8,y.forEach(Y=>{const H=Y.baseScale+Math.sin(L*2.4+Y.phase)*.45;Y.mesh.scale.setScalar(Math.max(.7,H))}),c.render(s,l)};return T(),()=>{cancelAnimationFrame(e.current),window.removeEventListener("mousemove",G),window.removeEventListener("resize",U),s.traverse(L=>{(L instanceof ui||L instanceof Bh||L instanceof Hh)&&L.geometry.dispose()}),v.dispose(),g.dispose(),b.dispose(),w.dispose(),S.dispose(),c.dispose(),i.contains(c.domElement)&&i.removeChild(c.domElement)}},[]),j.jsx("div",{"code-path":"src\\sections\\IndustrialBackground.tsx:203:5",ref:o,style:{position:"absolute",inset:0,zIndex:0,pointerEvents:"auto"}})}const yA=["Ingeniería","Automatización","Instalaciones Eléctricas","Tableros","Mantenimiento","Instrumentación","Metalmecánica","Obras Industriales","Tecnología Industrial"];function MA(){const o=_e.useRef(null);return _e.useEffect(()=>{const e=o.current;if(!e)return;e.querySelectorAll(".hero-animate").forEach((s,l)=>{const c=s;c.style.opacity="0",c.style.transform="translateY(20px)",c.style.transition=`opacity 0.6s ease-out ${l*.2}s, transform 0.6s ease-out ${l*.2}s`,setTimeout(()=>{c.style.opacity="1",c.style.transform="translateY(0)"},100)})},[]),j.jsxs("section",{"code-path":"src\\sections\\HeroSection.tsx:28:5",id:"hero",className:"relative min-h-screen overflow-hidden",style:{backgroundColor:"#1a1a1a",clipPath:"polygon(0 0, 100% 0, 100% calc(100% - 80px), 0 100%)"},children:[j.jsx(SA,{"code-path":"src\\sections\\HeroSection.tsx:37:7"}),j.jsx("div",{"code-path":"src\\sections\\HeroSection.tsx:40:7",className:"absolute inset-0 z-[1]",style:{background:"linear-gradient(90deg, rgba(7,16,25,0.74) 0%, rgba(7,16,25,0.44) 45%, rgba(7,16,25,0.82) 100%), linear-gradient(to bottom, rgba(7,16,25,0.12) 0%, rgba(7,16,25,0.84) 100%)"}}),j.jsxs("div",{"code-path":"src\\sections\\HeroSection.tsx:49:7",ref:o,className:"relative z-[2] flex min-h-screen flex-col items-center justify-center px-6 pb-24 text-center",children:[j.jsx("p",{"code-path":"src\\sections\\HeroSection.tsx:53:9",className:"hero-animate mb-6 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"IMANTEK S.A.S. · NIT: 902069790-1"}),j.jsx("h1",{"code-path":"src\\sections\\HeroSection.tsx:60:9",className:"hero-animate mb-6 max-w-[800px] text-3xl font-bold uppercase leading-[1.1] sm:text-4xl md:text-[52px]",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#ffffff"},children:"Ingeniería y servicios técnicos integrales para operaciones seguras y confiables"}),j.jsx("p",{"code-path":"src\\sections\\HeroSection.tsx:67:9",className:"hero-animate mb-8 max-w-[600px] text-base leading-relaxed sm:text-lg",style:{fontFamily:"'Inter', sans-serif",color:"#8a8580"},children:"Servicios técnicos integrales para operaciones seguras y confiables"}),j.jsx("div",{"code-path":"src\\sections\\HeroSection.tsx:75:9",className:"hero-animate mb-10 flex flex-wrap justify-center gap-3",children:yA.map(e=>j.jsx("span",{"code-path":"src\\sections\\HeroSection.tsx:77:13",className:"border px-4 py-2 text-xs uppercase tracking-[1.5px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#cccccc",borderColor:"#555555"},children:e},e))}),j.jsx("a",{"code-path":"src\\sections\\HeroSection.tsx:92:9",href:"https://wa.me/573181419074?text=Hola%20IMANTEK%2C%20necesito%20apoyo%20t%C3%A9cnico%20para%20un%20proyecto%20de%20ingenier%C3%ADa.",target:"_blank",rel:"noopener noreferrer",className:"hero-animate px-9 py-3.5 text-xs font-medium uppercase tracking-[1.5px] text-white transition-colors duration-300 hover:bg-[#007fb8]",style:{fontFamily:"'IBM Plex Mono', monospace",backgroundColor:"#009fe3"},children:"Solicitar cotización"}),j.jsx("div",{"code-path":"src\\sections\\HeroSection.tsx:106:9",className:"hero-animate absolute bottom-10 left-1/2 flex -translate-x-1/2 flex-col items-center",children:j.jsx("div",{"code-path":"src\\sections\\HeroSection.tsx:107:11",className:"relative h-10 w-[1px] overflow-hidden",style:{backgroundColor:"rgba(255,255,255,0.4)"},children:j.jsx("div",{"code-path":"src\\sections\\HeroSection.tsx:108:13",className:"absolute h-2.5 w-2.5 -translate-x-1/2 rounded-full",style:{backgroundColor:"rgba(255,255,255,0.6)",left:"50%",animation:"scrollBounce 2s ease-in-out infinite"}})})})]}),j.jsx("style",{"code-path":"src\\sections\\HeroSection.tsx:120:7",children:`
        @keyframes scrollBounce {
          0%, 100% { top: 0; opacity: 0.6; }
          50% { top: 24px; opacity: 0; }
        }
      `})]})}function Ma(o={}){const e=_e.useRef(null);return _e.useEffect(()=>{const i=e.current;if(!i)return;const{threshold:s=.15,delay:l=0,duration:c=.6,translateY:d=40,translateX:p=0,scale:m=1}=o;i.style.opacity="0",i.style.transform=`translateY(${d}px) translateX(${p}px) scale(${m})`,i.style.transition=`opacity ${c}s ease-out ${l}s, transform ${c}s ease-out ${l}s`,i.style.willChange="transform, opacity";const h=new IntersectionObserver(x=>{x.forEach(v=>{v.isIntersecting&&(i.style.opacity="1",i.style.transform="translateY(0) translateX(0) scale(1)",i.addEventListener("transitionend",()=>{i.style.willChange="auto"},{once:!0}),h.unobserve(i))})},{threshold:s});return h.observe(i),()=>{h.disconnect()}},[]),e}function EA(){const o=Ma({translateX:-30,duration:.7}),e=Ma({translateX:30,duration:.7,delay:.15});return j.jsx("section",{"code-path":"src\\sections\\AboutSection.tsx:15:5",id:"about",className:"relative",style:{backgroundColor:"#f5f3ef",marginTop:"-80px",paddingTop:"160px",paddingBottom:"100px"},children:j.jsx("div",{"code-path":"src\\sections\\AboutSection.tsx:25:7",className:"mx-auto max-w-[1200px] px-6",children:j.jsxs("div",{"code-path":"src\\sections\\AboutSection.tsx:26:9",className:"grid items-center gap-16 md:grid-cols-[55%_45%]",children:[j.jsxs("div",{"code-path":"src\\sections\\AboutSection.tsx:28:11",ref:o,children:[j.jsx("p",{"code-path":"src\\sections\\AboutSection.tsx:29:13",className:"mb-4 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Sobre nosotros"}),j.jsx("h2",{"code-path":"src\\sections\\AboutSection.tsx:36:13",className:"mb-6 text-3xl font-medium uppercase leading-[1.15] sm:text-4xl",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:"Impulsando operaciones con criterio técnico"}),j.jsx("p",{"code-path":"src\\sections\\AboutSection.tsx:43:13",className:"mb-8 text-base leading-[1.7]",style:{fontFamily:"'Inter', sans-serif",color:"#1a1a1a",fontSize:"17px"},children:"IMANTEK es una empresa colombiana especializada en ingeniería, mantenimiento y tecnología industrial. Acompañamos a empresas, comercios y clientes residenciales con soluciones técnicas de alto impacto. Respondemos ante cada desafío con criterio, seguridad y ejecución en campo. Nuestro equipo combina experiencia práctica y conocimiento técnico para garantizar operaciones continuas y confiables."}),j.jsxs("div",{"code-path":"src\\sections\\AboutSection.tsx:51:13",className:"flex flex-col gap-6 sm:flex-row",children:[j.jsxs("div",{"code-path":"src\\sections\\AboutSection.tsx:52:15",className:"flex-1 border p-6",style:{borderColor:"#d4d0ca"},children:[j.jsx("h3",{"code-path":"src\\sections\\AboutSection.tsx:53:17",className:"mb-3 text-base font-medium uppercase",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#009fe3"},children:"Misión"}),j.jsx("p",{"code-path":"src\\sections\\AboutSection.tsx:59:17",className:"text-sm leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#8a8580",fontSize:"15px"},children:"Brindar servicios técnicos integrales con criterio, seguridad y ejecución eficaz, siendo el aliado estratégico de nuestros clientes en el mantenimiento y la operación de sus activos críticos."})]}),j.jsxs("div",{"code-path":"src\\sections\\AboutSection.tsx:67:15",className:"flex-1 border p-6",style:{borderColor:"#d4d0ca"},children:[j.jsx("h3",{"code-path":"src\\sections\\AboutSection.tsx:68:17",className:"mb-3 text-base font-medium uppercase",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#009fe3"},children:"Visión"}),j.jsx("p",{"code-path":"src\\sections\\AboutSection.tsx:74:17",className:"text-sm leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#8a8580",fontSize:"15px"},children:"Ser reconocidos como la empresa de servicios técnicos de mayor confiabilidad y alcance en Colombia, líderes en la integración de mantenimiento, automatización y tecnología."})]})]})]}),j.jsx("div",{"code-path":"src\\sections\\AboutSection.tsx:85:11",ref:e,children:j.jsx("img",{"code-path":"src\\sections\\AboutSection.tsx:86:13",src:"/images/about-image.png",alt:"Ingeniero industrial IMANTEK en instalación",className:"h-auto w-full object-cover",style:{border:"2px solid #d4d0ca",aspectRatio:"3/4"}})})]})})})}const bA=o=>o.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),TA=o=>o.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,i,s)=>s?s.toUpperCase():i.toLowerCase()),nv=o=>{const e=TA(o);return e.charAt(0).toUpperCase()+e.slice(1)},Bv=(...o)=>o.filter((e,i,s)=>!!e&&e.trim()!==""&&s.indexOf(e)===i).join(" ").trim(),AA=o=>{for(const e in o)if(e.startsWith("aria-")||e==="role"||e==="title")return!0};var RA={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};const CA=_e.forwardRef(({color:o="currentColor",size:e=24,strokeWidth:i=2,absoluteStrokeWidth:s,className:l="",children:c,iconNode:d,...p},m)=>_e.createElement("svg",{ref:m,...RA,width:e,height:e,stroke:o,strokeWidth:s?Number(i)*24/Number(e):i,className:Bv("lucide",l),...!c&&!AA(p)&&{"aria-hidden":"true"},...p},[...d.map(([h,x])=>_e.createElement(h,x)),...Array.isArray(c)?c:[c]]));const $o=(o,e)=>{const i=_e.forwardRef(({className:s,...l},c)=>_e.createElement(CA,{ref:c,iconNode:e,className:Bv(`lucide-${bA(nv(o))}`,`lucide-${o}`,s),...l}));return i.displayName=nv(o),i};const wA=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],DA=$o("chevron-down",wA);const UA=[["path",{d:"m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z",key:"9ktpf1"}],["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]],NA=$o("compass",UA);const LA=[["path",{d:"M10 10V5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5",key:"1p9q5i"}],["path",{d:"M14 6a6 6 0 0 1 6 6v3",key:"1hnv84"}],["path",{d:"M4 15v-3a6 6 0 0 1 6-6",key:"9ciidu"}],["rect",{x:"2",y:"15",width:"20",height:"4",rx:"1",key:"g3x8cw"}]],OA=$o("hard-hat",LA);const PA=[["path",{d:"M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 15.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0L8.61 19.61a1 1 0 0 0-1.68.474 2.5 2.5 0 1 1-3.014-3.015 1 1 0 0 0 .474-1.68l-1.683-1.682a2.414 2.414 0 0 1 0-3.414L4.39 8.61a1 1 0 0 1 1.68.474 2.5 2.5 0 1 0 3.014-3.015 1 1 0 0 1-.474-1.68l1.683-1.682a2.414 2.414 0 0 1 3.414 0z",key:"w46dr5"}]],IA=$o("puzzle",PA);const FA=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}]],zA=$o("shield",FA),BA=[{title:"Servicios de Ingeniería",description:"Soluciones integrales de ingeniería para proyectos industriales de cualquier escala.",items:["Ingeniería eléctrica","Ingeniería electrónica","Ingeniería mecánica","Ingeniería industrial","Consultoría en ingeniería","Diseño y planeación de proyectos industriales","Supervisión e interventoría técnica"]},{title:"Automatización Industrial",description:"Diseño e implementación de sistemas automatizados para optimizar procesos productivos.",items:["Automatización de procesos industriales","Programación de PLC","Desarrollo de interfaces HMI","Implementación de sistemas SCADA","Integración de sistemas industriales","Control e instrumentación industrial"]},{title:"Instalaciones Eléctricas",description:"Diseño, montaje y construcción de sistemas eléctricos para todos los sectores.",items:["Instalaciones eléctricas industriales","Instalaciones eléctricas comerciales","Instalaciones eléctricas residenciales","Montajes eléctricos","Redes eléctricas industriales","Diseño y construcción de sistemas eléctricos"]},{title:"Tableros Eléctricos",description:"Diseño, fabricación e instalación de tableros eléctricos a medida.",items:["Diseño de tableros eléctricos","Fabricación de tableros eléctricos","Armado de tableros eléctricos","Instalación de tableros eléctricos","Adecuación y modernización de tableros eléctricos"]},{title:"Mantenimiento Industrial",description:"Programas de mantenimiento especializados para garantizar continuidad operativa.",items:["Mantenimiento preventivo","Mantenimiento correctivo","Mantenimiento predictivo","Diagnóstico de fallas","Reparación de maquinaria industrial","Soporte técnico especializado"]},{title:"Instrumentación y Control",description:"Calibración, puesta en marcha y optimización de instrumentos y sistemas de control.",items:["Calibración de instrumentos","Puesta en marcha de sistemas","Optimización de procesos","Configuración de equipos de control","Instrumentación industrial"]},{title:"Metalmecánica",description:"Fabricación, montaje y mantenimiento de estructuras metálicas con soldadura especializada.",items:["Fabricación de estructuras metálicas","Montaje de estructuras metálicas","Mantenimiento de estructuras metálicas","Trabajos de soldadura especializada"]},{title:"Obras Industriales",description:"Montajes y adecuaciones técnicas para plantas e infraestructura industrial.",items:["Montajes industriales","Obras civiles relacionadas con proyectos industriales","Adecuaciones técnicas para plantas industriales"]},{title:"Tecnología Industrial",description:"Integración de soluciones tecnológicas inteligentes para procesos productivos.",items:["Integración tecnológica","Desarrollo de soluciones industriales","Implementación de sistemas inteligentes para procesos productivos"]}];function HA(){const o=Ma({translateY:30}),e=_e.useRef(null),[i,s]=_e.useState(null),l=c=>{s(d=>d===c?null:c)};return _e.useEffect(()=>{const c=e.current;if(!c)return;c.querySelectorAll(".service-card").forEach(m=>{const h=m;h.style.opacity="0",h.style.transform="translateY(40px)"});const p=new IntersectionObserver(m=>{m.forEach(h=>{h.isIntersecting&&(h.target.querySelectorAll(".service-card").forEach((v,g)=>{const M=v;M.style.transition=`opacity 0.6s ease-out ${g*.08}s, transform 0.6s ease-out ${g*.08}s`,M.style.opacity="1",M.style.transform="translateY(0)"}),p.unobserve(h.target))})},{threshold:.05});return p.observe(c),()=>p.disconnect()},[]),j.jsx("section",{"code-path":"src\\sections\\ServicesSection.tsx:159:5",id:"servicios",className:"border-t",style:{backgroundColor:"#f5f3ef",borderColor:"#d4d0ca",paddingTop:"100px",paddingBottom:"100px"},children:j.jsxs("div",{"code-path":"src\\sections\\ServicesSection.tsx:169:7",className:"mx-auto max-w-[1200px] px-6",children:[j.jsxs("div",{"code-path":"src\\sections\\ServicesSection.tsx:171:9",ref:o,children:[j.jsx("p",{"code-path":"src\\sections\\ServicesSection.tsx:172:11",className:"mb-4 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Lo que hacemos"}),j.jsx("h2",{"code-path":"src\\sections\\ServicesSection.tsx:178:11",className:"mb-4 text-3xl font-medium uppercase leading-[1.15] sm:text-4xl",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:"Portafolio de servicios"}),j.jsx("p",{"code-path":"src\\sections\\ServicesSection.tsx:184:11",className:"mb-12 max-w-[700px] leading-[1.7]",style:{fontFamily:"'Inter', sans-serif",color:"#1a1a1a",fontSize:"17px"},children:"Soluciones técnicas integrales respaldadas por nuestra cámara de comercio: desde ingeniería y automatización hasta metalmecánica y tecnología industrial, bajo un mismo equipo de confianza."})]}),j.jsx("div",{"code-path":"src\\sections\\ServicesSection.tsx:195:9",ref:e,className:"grid gap-5 sm:grid-cols-2 lg:grid-cols-3",children:BA.map((c,d)=>{const p=i===d;return j.jsxs("div",{"code-path":"src\\sections\\ServicesSection.tsx:200:15",className:"service-card group cursor-pointer border transition-all duration-300",style:{borderColor:p?"#009fe3":"#d4d0ca",borderLeftWidth:"3px",borderLeftColor:"#009fe3",backgroundColor:p?"rgba(0, 159, 227, 0.08)":"transparent"},onClick:()=>l(d),onMouseEnter:m=>{p||(m.currentTarget.style.borderColor="#009fe3",m.currentTarget.style.backgroundColor="rgba(0, 159, 227, 0.06)")},onMouseLeave:m=>{p||(m.currentTarget.style.borderColor="#d4d0ca",m.currentTarget.style.borderLeftColor="#009fe3",m.currentTarget.style.backgroundColor="transparent")},children:[j.jsxs("div",{"code-path":"src\\sections\\ServicesSection.tsx:228:17",className:"flex items-start justify-between p-6 pb-4",children:[j.jsx("div",{"code-path":"src\\sections\\ServicesSection.tsx:229:19",className:"flex items-center gap-4",children:j.jsx("h3",{"code-path":"src\\sections\\ServicesSection.tsx:230:21",className:"text-base font-medium uppercase leading-tight",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:c.title})}),j.jsx(DA,{"code-path":"src\\sections\\ServicesSection.tsx:240:19",size:18,className:"mt-1 shrink-0 transition-transform duration-300",style:{color:"#009fe3",transform:p?"rotate(180deg)":"rotate(0deg)"}})]}),j.jsx("p",{"code-path":"src\\sections\\ServicesSection.tsx:251:17",className:"px-6 pb-4 leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#8a8580",fontSize:"14px"},children:c.description}),j.jsx("div",{"code-path":"src\\sections\\ServicesSection.tsx:263:17",className:"overflow-hidden transition-all duration-400 ease-in-out",style:{maxHeight:p?"420px":"0px",opacity:p?1:0},children:j.jsx("ul",{"code-path":"src\\sections\\ServicesSection.tsx:270:19",className:"border-t px-6 py-4",style:{borderColor:"#e8e4de"},children:c.items.map(m=>j.jsxs("li",{"code-path":"src\\sections\\ServicesSection.tsx:272:23",className:"flex items-start gap-3 py-1.5",style:{fontFamily:"'Inter', sans-serif",color:"#555555",fontSize:"14px"},children:[j.jsx("span",{"code-path":"src\\sections\\ServicesSection.tsx:281:25",className:"mt-[7px] inline-block h-1.5 w-1.5 shrink-0 rounded-full",style:{backgroundColor:"#009fe3"}}),m]},m))})})]},c.title)})})]})})}const GA=[{number:"01",title:"Diagnóstico",description:"Análisis exhaustivo del sistema o activo. Identificamos el problema con precisión antes de proponer cualquier intervención."},{number:"02",title:"Propuesta",description:"Presentamos un plan de acción claro con alcance, recursos, tiempo y costo definidos para la aprobación del cliente."},{number:"03",title:"Ejecución",description:"Intervención en campo con personal calificado, equipos adecuados y protocolos de seguridad industrial vigentes."},{number:"04",title:"Entrega y Seguimiento",description:"Informe técnico detallado, garantía sobre el trabajo realizado y acompañamiento post-servicio."}];function VA(){const o=Ma({translateY:30}),e=_e.useRef(null),i=_e.useRef(null);return _e.useEffect(()=>{const s=e.current,l=i.current;if(!s||!l)return;const c=s.querySelectorAll(".method-step");c.forEach(p=>{const m=p;m.style.opacity="0",m.style.transform="translateY(30px)"}),l.style.transform="scaleX(0)",l.style.transformOrigin="left";const d=new IntersectionObserver(p=>{p.forEach(m=>{m.isIntersecting&&(setTimeout(()=>{l.style.transition="transform 0.8s ease-out",l.style.transform="scaleX(1)"},300),c.forEach((h,x)=>{const v=h;setTimeout(()=>{v.style.transition="opacity 0.6s ease-out, transform 0.6s ease-out",v.style.opacity="1",v.style.transform="translateY(0)"},x*150)}),d.unobserve(m.target))})},{threshold:.2});return d.observe(s),()=>d.disconnect()},[]),j.jsx("section",{"code-path":"src\\sections\\MethodologySection.tsx:79:5",id:"metodologia",className:"border-t",style:{backgroundColor:"#f5f3ef",borderColor:"#d4d0ca",paddingTop:"100px",paddingBottom:"100px"},children:j.jsxs("div",{"code-path":"src\\sections\\MethodologySection.tsx:84:7",className:"mx-auto max-w-[1200px] px-6",children:[j.jsxs("div",{"code-path":"src\\sections\\MethodologySection.tsx:86:9",ref:o,className:"mb-12",children:[j.jsx("p",{"code-path":"src\\sections\\MethodologySection.tsx:87:11",className:"mb-4 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Cómo trabajamos"}),j.jsx("h2",{"code-path":"src\\sections\\MethodologySection.tsx:93:11",className:"text-3xl font-medium uppercase leading-[1.15] sm:text-4xl",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:"Nuestra metodología"})]}),j.jsxs("div",{"code-path":"src\\sections\\MethodologySection.tsx:102:9",ref:e,className:"relative",children:[j.jsx("div",{"code-path":"src\\sections\\MethodologySection.tsx:104:11",ref:i,className:"absolute left-0 right-0 top-[30px] hidden h-[1px] md:block",style:{backgroundColor:"#d4d0ca"}}),j.jsx("div",{"code-path":"src\\sections\\MethodologySection.tsx:110:11",className:"grid gap-10 md:grid-cols-4 md:gap-6",children:GA.map(s=>j.jsxs("div",{"code-path":"src\\sections\\MethodologySection.tsx:112:15",className:"method-step",children:[j.jsx("div",{"code-path":"src\\sections\\MethodologySection.tsx:114:17",className:"mb-4 text-5xl",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:s.number}),j.jsx("h3",{"code-path":"src\\sections\\MethodologySection.tsx:122:17",className:"mb-3 text-lg font-medium uppercase",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:s.title}),j.jsx("p",{"code-path":"src\\sections\\MethodologySection.tsx:130:17",className:"leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#8a8580",fontSize:"15px"},children:s.description})]},s.number))})]})]})})}const kA=[{name:"Industrial & Logístico",description:"Soluciones de ingeniería y mantenimiento preventivo/correctivo diseñadas para garantizar la continuidad operativa.",items:["Plantas de producción","Fábricas","Centros de distribución","Bodegas"],image:"/images/sector-industrial.jpg"},{name:"Comercial & Retail",description:"Instalaciones eléctricas, climatización y mantenimiento de infraestructura orientados a crear entornos confortables y seguros.",items:["Centros comerciales","Hoteles","Restaurantes"],image:"/images/sector-commercial-retail.jpg"},{name:"Residencial & Copropiedades",description:"Servicios preventivos programados y atención técnica oportuna para la conservación física.",items:["Conjuntos residenciales","Condominios","Zonas comunes"],image:"/images/sector-residential.jpg"}];function XA(){const o=Ma({translateY:30}),e=_e.useRef(null);return _e.useEffect(()=>{const i=e.current;if(!i)return;i.querySelectorAll(".sector-card").forEach(c=>{const d=c;d.style.opacity="0",d.style.transform="translateY(30px)"});const l=new IntersectionObserver(c=>{c.forEach(d=>{d.isIntersecting&&(d.target.querySelectorAll(".sector-card").forEach((m,h)=>{const x=m;setTimeout(()=>{x.style.transition="opacity 0.7s ease-out, transform 0.7s ease-out",x.style.opacity="1",x.style.transform="translateY(0)"},h*120)}),l.unobserve(d.target))})},{threshold:.15});return l.observe(i),()=>l.disconnect()},[]),j.jsx("section",{"code-path":"src\\sections\\SectorsSection.tsx:65:5",id:"sectores",className:"border-t",style:{backgroundColor:"#f5f3ef",borderColor:"#d4d0ca",paddingTop:"100px",paddingBottom:"100px"},children:j.jsxs("div",{"code-path":"src\\sections\\SectorsSection.tsx:70:7",className:"mx-auto max-w-[1200px] px-6",children:[j.jsxs("div",{"code-path":"src\\sections\\SectorsSection.tsx:72:9",ref:o,className:"mb-14",children:[j.jsx("p",{"code-path":"src\\sections\\SectorsSection.tsx:73:11",className:"mb-4 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Mercado"}),j.jsx("h2",{"code-path":"src\\sections\\SectorsSection.tsx:79:11",className:"mb-4 text-3xl font-medium uppercase leading-[1.15] sm:text-4xl",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:"Sectores que atendemos"}),j.jsx("p",{"code-path":"src\\sections\\SectorsSection.tsx:85:11",className:"max-w-[700px] leading-[1.7]",style:{fontFamily:"'Inter', sans-serif",color:"#1a1a1a",fontSize:"17px"},children:"Adaptamos nuestras soluciones técnicas a las exigencias operativas, de seguridad y normativas de cada sector económico."})]}),j.jsx("div",{"code-path":"src\\sections\\SectorsSection.tsx:94:9",ref:e,className:"grid gap-6 sm:grid-cols-2 lg:grid-cols-3",children:kA.map(i=>j.jsx("div",{"code-path":"src\\sections\\SectorsSection.tsx:96:13",className:"sector-card",children:j.jsx(WA,{"code-path":"src\\sections\\SectorsSection.tsx:97:15",sector:i})},i.name))})]})})}function WA({sector:o}){return j.jsxs("div",{"code-path":"src\\sections\\SectorsSection.tsx:108:5",className:"group h-full flex flex-col",children:[j.jsx("div",{"code-path":"src\\sections\\SectorsSection.tsx:110:7",className:"overflow-hidden",style:{aspectRatio:"16/10"},children:j.jsx("img",{"code-path":"src\\sections\\SectorsSection.tsx:111:9",src:o.image,alt:o.name,className:"h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"})}),j.jsxs("div",{"code-path":"src\\sections\\SectorsSection.tsx:119:7",className:"border border-t-0 p-6 flex-1 flex flex-col justify-between",style:{borderColor:"#d4d0ca"},children:[j.jsxs("div",{"code-path":"src\\sections\\SectorsSection.tsx:120:9",children:[j.jsx("h3",{"code-path":"src\\sections\\SectorsSection.tsx:121:11",className:"mb-2 text-lg font-medium uppercase",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:o.name}),j.jsx("p",{"code-path":"src\\sections\\SectorsSection.tsx:127:11",className:"mb-4 leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#8a8580",fontSize:"15px"},children:o.description})]}),j.jsx("ul",{"code-path":"src\\sections\\SectorsSection.tsx:134:9",className:"flex flex-wrap gap-x-4 gap-y-2 mt-auto",children:o.items.map(e=>j.jsxs("li",{"code-path":"src\\sections\\SectorsSection.tsx:136:13",className:"flex items-center gap-2 text-sm",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#8a8580"},children:[j.jsx("span",{"code-path":"src\\sections\\SectorsSection.tsx:141:15",className:"inline-block h-1 w-1 rounded-full",style:{backgroundColor:"#009fe3"}}),e]},e))})]})]})}const qA=[{icon:IA,title:"Solución 360°",description:"Un solo proveedor para múltiples disciplinas técnicas: eléctrica, mecánica, TI e instrumentación."},{icon:OA,title:"Ejecución en campo",description:"Presencia directa en el lugar de trabajo con técnicos calificados y equipamiento adecuado."},{icon:zA,title:"Seguridad primero",description:"Protocolos de seguridad industrial en cada intervención. Cumplimiento normativo garantizado."},{icon:NA,title:"Criterio técnico",description:"Diagnóstico preciso antes de actuar. Soluciones sostenibles, no parches temporales."}],YA=[{title:"Creciente demanda",text:"La industria y el comercio en Colombia incrementan su inversión en mantenimiento preventivo y automatización para reducir costos operativos y tiempos de parada."},{title:"Transformación digital",text:"Las empresas buscan integrar IoT, SCADA y automatización para mejorar su competitividad, creando oportunidad para proveedores con capacidad multidisciplinaria."},{title:"Déficit de proveedores integrales",text:"La mayoría de los proveedores son especialistas en una sola disciplina. IMANTEK cubre múltiples frentes, reduciendo la complejidad logística del cliente."},{title:"Eficiencia energética",text:"La transición hacia energías más eficientes abre nuevas verticales de negocio donde IMANTEK puede ofrecer soluciones de alto valor."}];function jA(){const o=Ma({translateY:30}),e=_e.useRef(null),i=_e.useRef(null);return _e.useEffect(()=>{const s=e.current;if(!s)return;s.querySelectorAll(".diff-card").forEach(d=>{const p=d;p.style.opacity="0",p.style.transform="translateY(30px)"});const c=new IntersectionObserver(d=>{d.forEach(p=>{p.isIntersecting&&(p.target.querySelectorAll(".diff-card").forEach((h,x)=>{const v=h;setTimeout(()=>{v.style.transition="opacity 0.6s ease-out, transform 0.6s ease-out",v.style.opacity="1",v.style.transform="translateY(0)"},x*120)}),c.unobserve(p.target))})},{threshold:.15});return c.observe(s),()=>c.disconnect()},[]),_e.useEffect(()=>{const s=i.current;if(!s)return;s.querySelectorAll(".opp-block").forEach(d=>{const p=d;p.style.opacity="0",p.style.transform="translateY(30px)"});const c=new IntersectionObserver(d=>{d.forEach(p=>{p.isIntersecting&&(p.target.querySelectorAll(".opp-block").forEach((h,x)=>{const v=h;setTimeout(()=>{v.style.transition="opacity 0.6s ease-out, transform 0.6s ease-out",v.style.opacity="1",v.style.transform="translateY(0)"},x*80)}),c.unobserve(p.target))})},{threshold:.1});return c.observe(s),()=>c.disconnect()},[]),j.jsx("section",{"code-path":"src\\sections\\WhyUsSection.tsx:123:5",id:"porque",style:{backgroundColor:"#1a1a1a",paddingTop:"100px",paddingBottom:"100px"},children:j.jsxs("div",{"code-path":"src\\sections\\WhyUsSection.tsx:127:7",className:"mx-auto max-w-[1200px] px-6",children:[j.jsx("div",{"code-path":"src\\sections\\WhyUsSection.tsx:129:9",ref:o,className:"mb-12",children:j.jsx("h2",{"code-path":"src\\sections\\WhyUsSection.tsx:130:11",className:"text-3xl font-medium uppercase leading-[1.15] sm:text-4xl",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#ffffff"},children:"¿Por qué elegir IMANTEK?"})}),j.jsx("div",{"code-path":"src\\sections\\WhyUsSection.tsx:138:9",ref:e,className:"mb-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4",children:qA.map(s=>{const l=s.icon;return j.jsxs("div",{"code-path":"src\\sections\\WhyUsSection.tsx:142:15",className:"diff-card border p-8 transition-all duration-300 hover:border-[#009fe3]",style:{borderColor:"#333333"},onMouseEnter:c=>{c.currentTarget.style.backgroundColor="rgba(0, 159, 227, 0.1)"},onMouseLeave:c=>{c.currentTarget.style.backgroundColor="transparent"},children:[j.jsx(l,{"code-path":"src\\sections\\WhyUsSection.tsx:153:17",size:40,style:{color:"#009fe3"},strokeWidth:1.2}),j.jsx("h3",{"code-path":"src\\sections\\WhyUsSection.tsx:154:17",className:"mb-3 mt-5 text-lg font-medium uppercase",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#ffffff"},children:s.title}),j.jsx("p",{"code-path":"src\\sections\\WhyUsSection.tsx:160:17",className:"leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#aaaaaa",fontSize:"15px"},children:s.description})]},s.title)})}),j.jsxs("div",{"code-path":"src\\sections\\WhyUsSection.tsx:172:9",className:"border-t pt-16",style:{borderColor:"#333333"},children:[j.jsx("p",{"code-path":"src\\sections\\WhyUsSection.tsx:176:11",className:"mb-4 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Contexto estratégico"}),j.jsx("h3",{"code-path":"src\\sections\\WhyUsSection.tsx:182:11",className:"mb-8 text-2xl font-medium uppercase sm:text-3xl",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#ffffff"},children:"Oportunidad de mercado"}),j.jsx("div",{"code-path":"src\\sections\\WhyUsSection.tsx:189:11",ref:i,className:"grid gap-8 sm:grid-cols-2",children:YA.map(s=>j.jsxs("div",{"code-path":"src\\sections\\WhyUsSection.tsx:191:15",className:"opp-block",children:[j.jsx("h4",{"code-path":"src\\sections\\WhyUsSection.tsx:192:17",className:"mb-2 text-base font-medium uppercase",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#ffffff"},children:s.title}),j.jsx("p",{"code-path":"src\\sections\\WhyUsSection.tsx:198:17",className:"leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#aaaaaa",fontSize:"15px"},children:s.text})]},s.title))})]})]})})}const ZA=[{year:"2025",title:"Consolidación",items:["Estructurar portafolio de servicios completo","Captar primeros clientes ancla industriales y comerciales","Establecer procesos operativos y de calidad","Presencia digital sólida"]},{year:"2026",title:"Crecimiento",items:["Ampliar cartera de clientes en 3+ sectores","Lanzar servicio de contratos de mantenimiento recurrente","Incorporar capacidades en automatización e IoT","Crecer equipo técnico especializado"]},{year:"2027",title:"Expansión",items:["Presencia en múltiples ciudades de Colombia","Plataforma propia de monitoreo y gestión de activos","Alianzas estratégicas con fabricantes y distribuidores","Certificaciones industriales y de calidad"]}];function KA(){const o=Ma({translateY:30}),e=_e.useRef(null),i=_e.useRef(null);return _e.useEffect(()=>{const s=e.current,l=i.current;if(!s||!l)return;const c=s.querySelectorAll(".year-badge"),d=s.querySelectorAll(".phase-list");c.forEach(m=>{const h=m;h.style.opacity="0",h.style.transform="scale(0.8)"}),d.forEach(m=>{const h=m;h.style.opacity="0",h.style.transform="translateY(20px)"}),l.style.transform="scaleX(0)",l.style.transformOrigin="left";const p=new IntersectionObserver(m=>{m.forEach(h=>{h.isIntersecting&&(setTimeout(()=>{l.style.transition="transform 1s ease-out",l.style.transform="scaleX(1)"},200),c.forEach((x,v)=>{const g=x;setTimeout(()=>{g.style.transition="opacity 0.5s ease-out, transform 0.5s ease-out",g.style.opacity="1",g.style.transform="scale(1)"},400+v*200)}),d.forEach((x,v)=>{const g=x;setTimeout(()=>{g.style.transition="opacity 0.6s ease-out, transform 0.6s ease-out",g.style.opacity="1",g.style.transform="translateY(0)"},600+v*150)}),p.unobserve(h.target))})},{threshold:.15});return p.observe(s),()=>p.disconnect()},[]),j.jsx("section",{"code-path":"src\\sections\\RoadmapSection.tsx:107:5",id:"roadmap",className:"border-t",style:{backgroundColor:"#f5f3ef",borderColor:"#d4d0ca",paddingTop:"100px",paddingBottom:"100px"},children:j.jsxs("div",{"code-path":"src\\sections\\RoadmapSection.tsx:112:7",className:"mx-auto max-w-[1200px] px-6",children:[j.jsxs("div",{"code-path":"src\\sections\\RoadmapSection.tsx:114:9",ref:o,className:"mb-14",children:[j.jsx("p",{"code-path":"src\\sections\\RoadmapSection.tsx:115:11",className:"mb-4 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Hoja de ruta"}),j.jsx("h2",{"code-path":"src\\sections\\RoadmapSection.tsx:121:11",className:"text-3xl font-medium uppercase leading-[1.15] sm:text-4xl",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:"Metas estratégicas 2025 – 2027"})]}),j.jsxs("div",{"code-path":"src\\sections\\RoadmapSection.tsx:130:9",ref:e,className:"relative",children:[j.jsx("div",{"code-path":"src\\sections\\RoadmapSection.tsx:132:11",ref:i,className:"absolute left-0 right-0 top-[22px] hidden h-[1px] md:block",style:{backgroundColor:"#d4d0ca"}}),j.jsx("div",{"code-path":"src\\sections\\RoadmapSection.tsx:138:11",className:"grid gap-10 md:grid-cols-3 md:gap-8",children:ZA.map(s=>j.jsxs("div",{"code-path":"src\\sections\\RoadmapSection.tsx:140:15",children:[j.jsx("div",{"code-path":"src\\sections\\RoadmapSection.tsx:142:17",className:"year-badge mb-6 inline-block border px-4 py-1.5 text-sm",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3",borderColor:"#009fe3"},children:s.year}),j.jsx("h3",{"code-path":"src\\sections\\RoadmapSection.tsx:154:17",className:"mb-4 text-lg font-medium uppercase",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#1a1a1a"},children:s.title}),j.jsx("ul",{"code-path":"src\\sections\\RoadmapSection.tsx:162:17",className:"phase-list space-y-2",children:s.items.map(l=>j.jsxs("li",{"code-path":"src\\sections\\RoadmapSection.tsx:164:21",className:"flex items-start gap-3 leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#8a8580",fontSize:"15px"},children:[j.jsx("span",{"code-path":"src\\sections\\RoadmapSection.tsx:169:23",className:"mt-2 inline-block h-[2px] w-3 shrink-0",style:{backgroundColor:"#009fe3"}}),l]},l))})]},s.year))})]})]})})}function QA(){const o=Ma({translateX:-20,duration:.6}),e=Ma({translateX:20,duration:.6,delay:.15});return j.jsx("section",{"code-path":"src\\sections\\ContactSection.tsx:8:5",id:"contacto",className:"border-t",style:{backgroundColor:"#1a1a1a",borderColor:"#333333",paddingTop:"100px",paddingBottom:"100px"},children:j.jsxs("div",{"code-path":"src\\sections\\ContactSection.tsx:18:7",className:"mx-auto grid max-w-[1200px] gap-16 px-6 md:grid-cols-2",children:[j.jsxs("div",{"code-path":"src\\sections\\ContactSection.tsx:20:9",ref:o,children:[j.jsx("p",{"code-path":"src\\sections\\ContactSection.tsx:21:11",className:"mb-4 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Hablemos"}),j.jsx("h2",{"code-path":"src\\sections\\ContactSection.tsx:27:11",className:"mb-6 text-3xl font-medium uppercase leading-[1.15] sm:text-4xl",style:{fontFamily:"'Space Grotesk', sans-serif",color:"#ffffff"},children:"¿Listo para optimizar sus operaciones?"}),j.jsx("p",{"code-path":"src\\sections\\ContactSection.tsx:33:11",className:"mb-8 leading-relaxed",style:{fontFamily:"'Inter', sans-serif",color:"#aaaaaa",fontSize:"17px"},children:"Contacte a nuestro equipo de ingeniería y reciba una propuesta técnica personalizada sin costo."}),j.jsx("a",{"code-path":"src\\sections\\ContactSection.tsx:39:11",href:"https://wa.me/573181419074?text=Hola%20IMANTEK%2C%20necesito%20apoyo%20t%C3%A9cnico%20para%20un%20proyecto%20de%20ingenier%C3%ADa.",target:"_blank",rel:"noopener noreferrer",className:"inline-block px-9 py-3.5 text-xs font-medium uppercase tracking-[1.5px] text-white transition-colors duration-300 hover:bg-[#007fb8]",style:{fontFamily:"'IBM Plex Mono', monospace",backgroundColor:"#009fe3"},children:"Solicitar cotización"})]}),j.jsxs("div",{"code-path":"src\\sections\\ContactSection.tsx:54:9",ref:e,className:"md:mt-0 mt-12",children:[j.jsxs("div",{"code-path":"src\\sections\\ContactSection.tsx:55:11",className:"mb-7",children:[j.jsx("p",{"code-path":"src\\sections\\ContactSection.tsx:56:13",className:"mb-2 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Sitio web"}),j.jsx("p",{"code-path":"src\\sections\\ContactSection.tsx:62:13",style:{fontFamily:"'Inter', sans-serif",color:"#cccccc",fontSize:"16px"},children:"imantek.com.co"})]}),j.jsxs("div",{"code-path":"src\\sections\\ContactSection.tsx:67:11",className:"mb-7",children:[j.jsx("p",{"code-path":"src\\sections\\ContactSection.tsx:68:13",className:"mb-2 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Correo electrónico"}),j.jsx("p",{"code-path":"src\\sections\\ContactSection.tsx:74:13",style:{fontFamily:"'Inter', sans-serif",color:"#cccccc",fontSize:"16px"},children:"Imanteksas@gmail.com"})]}),j.jsxs("div",{"code-path":"src\\sections\\ContactSection.tsx:79:11",className:"mb-7",children:[j.jsx("p",{"code-path":"src\\sections\\ContactSection.tsx:80:13",className:"mb-2 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Teléfono / WhatsApp"}),j.jsx("a",{"code-path":"src\\sections\\ContactSection.tsx:86:13",href:"https://wa.me/573181419074",target:"_blank",rel:"noopener noreferrer",className:"transition-colors hover:text-[#009fe3]",style:{fontFamily:"'Inter', sans-serif",color:"#cccccc",fontSize:"16px"},children:"+57 318 141 9074"})]}),j.jsxs("div",{"code-path":"src\\sections\\ContactSection.tsx:97:11",children:[j.jsx("p",{"code-path":"src\\sections\\ContactSection.tsx:98:13",className:"mb-2 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Ubicación"}),j.jsxs("p",{"code-path":"src\\sections\\ContactSection.tsx:104:13",style:{fontFamily:"'Inter', sans-serif",color:"#cccccc",fontSize:"16px"},children:["Br. Villa Estrella Transv.54 #80-863,",j.jsx("br",{"code-path":"src\\sections\\ContactSection.tsx:105:52"}),"Cartagena de Indias, Colombia"]})]})]})]})})}function JA(){const o=_e.useRef(null),e=_e.useRef(0),i=_e.useRef(!1);return _e.useEffect(()=>{const s=o.current;if(!s)return;const l=s.getContext("2d");if(!l)return;const c=Math.min(window.devicePixelRatio,2);function d(){if(!s)return;const C=s.parentElement;C&&(s.width=C.clientWidth*c,s.height=C.clientHeight*c,s.style.width=C.clientWidth+"px",s.style.height=C.clientHeight+"px",l.setTransform(c,0,0,c,0,0))}d();const p=["#ffffff","#cccccc","#aaaaaa","#888888"],m=2e3,h=120,x=[];for(let C=0;C<m;C++)x.push({x:Math.random()*(s?.clientWidth||0),y:Math.random()*(s?.clientHeight||0),vx:(Math.random()-.5)*.5,vy:(Math.random()-.5)*.5,size:.5+Math.random()*1.5,color:p[Math.floor(Math.random()*p.length)],alpha:.2+Math.random()*.5});let v=0,g=0,M=!1;const b=C=>{const N=s.getBoundingClientRect();v=C.clientX-N.left,g=C.clientY-N.top,M=!0,setTimeout(()=>{M=!1},500)};s.addEventListener("click",b);const w=new IntersectionObserver(C=>{C.forEach(N=>{i.current=N.isIntersecting})},{threshold:.05});w.observe(s);function y(){if(e.current=requestAnimationFrame(y),!i.current||!l||!s)return;const C=s.clientWidth,N=s.clientHeight,P=C/2,G=N/2;l.fillStyle="rgba(26, 26, 26, 0.15)",l.fillRect(0,0,C,N);for(const U of x){const F=P-U.x,T=G-U.y,L=Math.sqrt(F*F+T*T)+1,Y=h/(L*L);if(U.vx+=F/L*Y*.01,U.vy+=T/L*Y*.01,M){const H=v-U.x,K=g-U.y,lt=Math.sqrt(H*H+K*K)+1,ut=200/(lt*lt);U.vx-=H/lt*ut*.1,U.vy-=K/lt*ut*.1}U.vx*=.995,U.vy*=.995,U.x+=U.vx,U.y+=U.vy,U.x<0&&(U.x=C),U.x>C&&(U.x=0),U.y<0&&(U.y=N),U.y>N&&(U.y=0),l.beginPath(),l.arc(U.x,U.y,U.size,0,Math.PI*2),l.fillStyle=U.color,l.globalAlpha=U.alpha,l.fill()}l.globalAlpha=1}y();const S=()=>d();return window.addEventListener("resize",S),()=>{cancelAnimationFrame(e.current),w.disconnect(),s.removeEventListener("click",b),window.removeEventListener("resize",S)}},[]),j.jsx("canvas",{"code-path":"src\\sections\\ParticleField.tsx:155:5",ref:o,style:{position:"absolute",inset:0,zIndex:0,pointerEvents:"auto"}})}function $A(){return j.jsxs("footer",{"code-path":"src\\sections\\Footer.tsx:6:5",className:"relative overflow-hidden border-t",style:{backgroundColor:"#1a1a1a",borderColor:"#333333"},children:[j.jsx(JA,{"code-path":"src\\sections\\Footer.tsx:14:7"}),j.jsxs("div",{"code-path":"src\\sections\\Footer.tsx:17:7",className:"relative z-[1] mx-auto max-w-[1200px] px-6",style:{paddingTop:"80px",paddingBottom:"40px"},children:[j.jsxs("div",{"code-path":"src\\sections\\Footer.tsx:21:9",className:"mb-16 grid gap-10 sm:grid-cols-3",children:[j.jsxs("div",{"code-path":"src\\sections\\Footer.tsx:23:11",children:[j.jsx(iv,{"code-path":"src\\sections\\Footer.tsx:24:13",className:"mb-4 text-3xl"}),j.jsx("p",{"code-path":"src\\sections\\Footer.tsx:25:13",className:"text-sm",style:{fontFamily:"'Inter', sans-serif",color:"#666666"},children:"Ingeniería · Mantenimiento · Tecnología"})]}),j.jsxs("div",{"code-path":"src\\sections\\Footer.tsx:34:11",children:[j.jsx("p",{"code-path":"src\\sections\\Footer.tsx:35:13",className:"mb-4 text-xs uppercase tracking-[2px]",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#009fe3"},children:"Síguenos"}),j.jsxs("div",{"code-path":"src\\sections\\Footer.tsx:41:13",className:"flex flex-col gap-2",children:[j.jsx("a",{"code-path":"src\\sections\\Footer.tsx:42:15",href:"https://www.instagram.com/imanteksas",target:"_blank",rel:"noopener noreferrer",className:"text-sm text-[#999999] transition-colors hover:text-white",style:{fontFamily:"'Inter', sans-serif"},children:"Instagram"}),j.jsx("a",{"code-path":"src\\sections\\Footer.tsx:51:15",href:"https://www.facebook.com/people/Imantek-SAS",target:"_blank",rel:"noopener noreferrer",className:"text-sm text-[#999999] transition-colors hover:text-white",style:{fontFamily:"'Inter', sans-serif"},children:"Facebook"}),j.jsx("a",{"code-path":"src\\sections\\Footer.tsx:60:15",href:"https://wa.me/573181419074",target:"_blank",rel:"noopener noreferrer",className:"text-sm text-[#999999] transition-colors hover:text-white",style:{fontFamily:"'Inter', sans-serif"},children:"WhatsApp"})]})]}),j.jsx("div",{"code-path":"src\\sections\\Footer.tsx:73:11",className:"sm:text-right",children:j.jsxs("p",{"code-path":"src\\sections\\Footer.tsx:74:13",className:"text-sm",style:{fontFamily:"'Inter', sans-serif",color:"#666666"},children:["© 2025–2026 IMANTEK S.A.S.",j.jsx("br",{"code-path":"src\\sections\\Footer.tsx:78:41"}),"Colombia · imantek.com.co"]})})]}),j.jsxs("div",{"code-path":"src\\sections\\Footer.tsx:85:9",className:"flex flex-col items-center justify-between gap-4 border-t pt-6 sm:flex-row",style:{borderColor:"#333333"},children:[j.jsx("p",{"code-path":"src\\sections\\Footer.tsx:89:11",className:"text-xs",style:{fontFamily:"'Inter', sans-serif",color:"#666666"},children:"© 2025–2026 IMANTEK S.A.S. · Colombia · imantek.com.co"}),j.jsx("p",{"code-path":"src\\sections\\Footer.tsx:95:11",className:"text-xs",style:{fontFamily:"'IBM Plex Mono', monospace",color:"#555555"},children:"Portafolio Corporativo 2025–2027"})]})]})]})}function t3(){const[o,e]=_e.useState(!1);return _e.useEffect(()=>{const i=()=>{e(window.scrollY>window.innerHeight*.5)};return window.addEventListener("scroll",i),()=>window.removeEventListener("scroll",i)},[]),j.jsxs("a",{"code-path":"src\\sections\\WhatsAppButton.tsx:15:5",href:"https://wa.me/573181419074?text=Hola%20IMANTEK%2C%20necesito%20apoyo%20t%C3%A9cnico%20para%20un%20proyecto%20de%20ingenier%C3%ADa.",target:"_blank",rel:"noopener noreferrer",className:"fixed bottom-6 right-6 z-[90] flex items-center gap-2 rounded-full px-5 py-3 text-sm font-medium text-white shadow-lg transition-all duration-300 hover:scale-105",style:{fontFamily:"'Inter', sans-serif",backgroundColor:"#25D366",opacity:o?1:0,transform:o?"translateY(0)":"translateY(20px)",pointerEvents:o?"auto":"none"},children:[j.jsx("svg",{"code-path":"src\\sections\\WhatsAppButton.tsx:28:7",xmlns:"http://www.w3.org/2000/svg",width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor",children:j.jsx("path",{"code-path":"src\\sections\\WhatsAppButton.tsx:35:9",d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"})}),"WhatsApp"]})}function e3(){return j.jsxs("div",{"code-path":"src\\App.tsx:15:5",className:"min-h-screen",children:[j.jsx(JS,{"code-path":"src\\App.tsx:16:7"}),j.jsx(MA,{"code-path":"src\\App.tsx:17:7"}),j.jsx(EA,{"code-path":"src\\App.tsx:18:7"}),j.jsx(HA,{"code-path":"src\\App.tsx:19:7"}),j.jsx(VA,{"code-path":"src\\App.tsx:20:7"}),j.jsx(XA,{"code-path":"src\\App.tsx:21:7"}),j.jsx(jA,{"code-path":"src\\App.tsx:22:7"}),j.jsx(KA,{"code-path":"src\\App.tsx:23:7"}),j.jsx(QA,{"code-path":"src\\App.tsx:24:7"}),j.jsx($A,{"code-path":"src\\App.tsx:25:7"}),j.jsx(t3,{"code-path":"src\\App.tsx:26:7"})]})}QS.createRoot(document.getElementById("root")).render(j.jsx(e3,{"code-path":"src\\main.tsx:11:53"}));
